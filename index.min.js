...
!(function (h) {
  ...
  function Y(e, n, t) {
    ...
    for (var r in n) ae(n, r) && (i[r] = e && ae(e, r) ? e[r] : n[r]);
    return i;
  }
  function t(e, n) {
    var t = 0;
    for (var i in n) ae(n, i) && ((e[i] = n[i]), t++);
    return t;
  }
  function L() {}
  function ie() {
    ...
    function e(t, i, r) {
      ...
      function e() {
        ...
        return (
          ...
          e instanceof c
            ? (e = e.v) instanceof f
              ? s.push.apply(s, r ? e.v.slice().reverse() : e.v)
              : s.push(e)
            : e !== u &&
              (e instanceof f
                ? a.push.apply(a, r ? e.v.slice().reverse() : e.v)
                : a.push(e)),
          n
        );
      }
      ...
      else for (o in t) if (ae(t, o) && e()) break;
      return s.concat(a);
    }
    (e.at_top = function (e) {
      return new c(e);
  ...
  function T(e, n) {
    for (var t = e.length; 0 <= --t; ) e[t] === n && e.splice(t, 1);
  }
  function s(e, a) {
    ...
    return (function e(n) {
      ...
      return (function (e, n) {
        ...
        return (
          i < e.length && t.push.apply(t, e.slice(i)),
          r < n.length && t.push.apply(t, n.slice(r)),
          t
        );
      })((i = e(i)), (r = e(r)));
    })(e);
  ...
  function W(e) {
    ...
    function a(e) {
      ...
      t += "switch(str){";
      for (var n = 0; n < e.length; ++n) t += "case " + o(e[n]) + ":";
  ...
  function oe(e, n) {
    for (var t = e.length; 0 <= --t; ) if (!n(e[t])) return !1;
    return !0;
  }
  function O() {
  ...
  function $(e) {
    for (var n, t = e.parent(-1), i = 0; (n = e.parent(i)); i++) {
      ...
      if (
        !(
          (n instanceof We && n.expressions[0] === t) ||
          ("Call" == n.TYPE && n.expression === t) ||
          (n instanceof Xe && n.expression === t) ||
          (n instanceof Ze && n.expression === t) ||
          (n instanceof tn && n.condition === t) ||
          (n instanceof nn && n.left === t) ||
          (n instanceof en && n.expression === t)
        )
      )
        return !1;
      t = n;
  ...
  function i(e, n, t, i) {
    ...
    var s = i && new i();
    ((s && s.initialize) || (t && t.initialize)) && (o += "this.initialize();"),
      (o += "}}");
    var u = new Function(o)();
    if (
      (s && ((u.prototype = s), (u.BASE = i)),
      i && i.SUBCLASSES.push(u),
      ((u.prototype.CTOR = u).PROPS = n || null),
      (u.SELF_PROPS = r),
      (u.SUBCLASSES = []),
      e && (u.prototype.TYPE = u.TYPE = e),
      t)
    )
      for (a in t)
        ae(t, a) &&
          (/^\$/.test(a) ? (u[a.substr(1)] = t[a]) : (u.prototype[a] = t[a]));
    return (
      (u.DEFMETHOD = function (e, n) {
        this.prototype[e] = n;
      }),
      void 0 !== h && (h["AST_" + e] = u),
      u
  ...
  (se.warn_function = null),
    (se.warn = function (e, n) {
  ...
  var pe = i(
    ...
    de = i("BlockStatement", null, { $documentation: "A block statement" }, pe),
    he = i(
      "EmptyStatement",
      null,
      {
            ...
            n.walk(
              new Sn(function (e) {
                e instanceof Oe &&
                  e.label &&
                  e.label.thedef === i &&
                  (e.label.thedef = t).references.push(e);
              })
            );
          }
          return n;
    ...
    Ae = i(
      ...
      "variables functions uses_with uses_eval parent_scope enclosed cname",
      {
        ...
        clone: function (e) {
          var n = this._clone(e);
          return (
            this.variables && (n.variables = this.variables.clone()),
            this.functions && (n.functions = this.functions.clone()),
            this.enclosed && (n.enclosed = this.enclosed.slice()),
            n
          );
        },
      },
    ...
    Ce = i("Defun", "inlined", { $documentation: "A function definition" }, ke),
    Be = i(
      "Jump",
      null,
      {
    ...
    Te = i("Return", null, { $documentation: "A `return` statement" }, Se),
    G = i("Throw", null, { $documentation: "A `throw` statement" }, Se),
    Oe = i(
      "LoopControl",
      "label",
      {
    ...
    $e = i("Break", null, { $documentation: "A `break` statement" }, Oe),
    ze = i("Continue", null, { $documentation: "A `continue` statement" }, Oe),
    Me = i(
      "If",
    ...
    Le = i("Var", null, { $documentation: "A `var` statement" }, Ue),
    ...
    mn = i("This", null, { $documentation: "The `this` symbol" }, cn),
    gn = i("Constant", null, {
    ...
    a = i("Atom", null, { $documentation: "Base class for atoms" }, gn),
    xn = i("Null", null, { $documentation: "The `null` atom", value: null }, a),
    An = i(
      "NaN",
      null,
    ...
    Fn = i("Boolean", null, { $documentation: "Base class for booleans" }, a),
    Cn = i(
      "False",
      null,
    ...
    Bn = i("True", null, { $documentation: "The `true` atom", value: !0 }, Fn);
  function Sn(e) {
    (this.visit = e),
      (this.stack = []),
  ...
  Sn.prototype = {
    ...
    push: function (e) {
      e instanceof ke
        ...
        : e instanceof fe &&
          !this.directives[e.value] &&
          (this.directives[e.value] = e),
        this.stack.push(e);
    },
    pop: function () {
      this.stack.pop() instanceof ke &&
    ...
    loopcontrol_target: function (e) {
      ...
      if (e.label)
        for (var t = n.length; 0 <= --t; ) {
          if ((i = n[t]) instanceof ve && i.label.name == e.label.name)
            return i.body;
        }
      else
        for (t = n.length; 0 <= --t; ) {
          var i;
          if ((i = n[t]) instanceof _e || (e instanceof $e && i instanceof qe))
            return i;
        }
    },
    in_boolean_context: function () {
      for (var e, n = this.self(), t = 0; (e = this.parent(t)); t++) {
        if (
          ...
          (e instanceof Me && e.condition === n) ||
          (e instanceof Qe && "!" == e.operator && e.expression === n)
        )
          return !0;
        if (
          !(
            (e instanceof nn && ("&&" == e.operator || "||" == e.operator)) ||
            e instanceof tn ||
            e.tail_node() === n
          )
        )
  ...
  function On(e) {
    return (
      (97 <= e && e <= 122) ||
      (65 <= e && e <= 90) ||
      (170 <= e && u.letter.test(String.fromCharCode(e)))
    );
  }
  function $n(e) {
    return (
      "string" == typeof e && (e = e.charCodeAt(0)), 55296 <= e && e <= 56319
    );
  }
  function zn(e) {
    return (
      "string" == typeof e && (e = e.charCodeAt(0)), 56320 <= e && e <= 57343
    );
  }
  function Mn(e) {
    return 48 <= e && e <= 57;
  ...
  function jn(e) {
    ...
    return (
      ...
      8204 == r ||
      8205 == r ||
      ((i = e), u.non_spacing_mark.test(i) || u.space_combining_mark.test(i)) ||
      ((t = e), u.connector_punctuation.test(t)) ||
      ((n = r), u.digit.test(String.fromCharCode(n)))
    );
  }
  function Nn(e) {
  ...
  (((Hn.prototype = Object.create(Error.prototype)).constructor =
    Hn).prototype.name = "SyntaxError"),
    n(Hn);
  var Pn = {};
  function Un(r, o, a, s) {
    var u = {
    ...
    function f(e, n) {
      ...
      return (
        P(t)
          ? ((u.newline_before = u.newline_before || !n),
            ++u.line,
            (u.col = 0),
            n || "\r" != t || "\n" != c() || (++u.pos, (t = "\n")))
          : ++u.col,
    ...
    function v(e, n, t) {
      ...
      return (
        /^(?:num|string|regexp)$/i.test(e) &&
          (i.raw = r.substring(i.pos, i.endpos)),
        t ||
          ((i.comments_before = u.comments_before),
          (i.comments_after = u.comments_before = [])),
        (u.newline_before = !1),
        new F(i)
      );
    }
    ...
    function g(r) {
      ...
      r && (e = r + e),
        H.test(e) &&
          D.has_directive("use strict") &&
          m("Legacy octal literals are not allowed in strict mode");
      var n = (function (e) {
    ...
    function b(e) {
      ...
      return "0" <= n && n <= "7"
        ? (function (e) {
            ...
            0 < e.length &&
              D.has_directive("use strict") &&
              m("Legacy octal escape sequences are not allowed in strict mode");
    ...
    function t(e) {
      for (var n = 0; 0 < e; --e) {
        ...
        isNaN(t) && m("Invalid hex-character pattern in string"),
          (n = (n << 4) | t);
      }
      return n;
    }
    var y = n("Unterminated string constant", function (e) {
      for (var n = f(), t = ""; ; ) {
        var i = f(!0, !0);
        if ("\\" == i) i = b(!0);
        else if (P(i)) m("Unterminated string constant");
        else if (i == n) break;
        t += i;
      }
      var r = v("string", t);
    ...
    function w(e) {
      ...
      return (
        -1 == i
          ? ((n = u.text.substr(u.pos)), (u.pos = u.text.length))
          : ((n = u.text.substring(u.pos, i)), (u.pos = i)),
        (u.col = u.tokcol + (u.pos - u.tokpos)),
        u.comments_before.push(v(e, n, !0)),
        (u.regex_allowed = t),
        D
      );
    }
    var e = n("Unterminated multiline comment", function () {
      ...
      return (
        l(t.length + 2),
        u.comments_before.push(v("comment2", t, !0)),
        (u.regex_allowed = e),
        D
      );
    });
    function x() {
      for (var e, n, t = !1, i = "", r = !1; null != (e = c()); )
        if (t)
          "u" != e && m("Expecting UnicodeEscapeSequence -- uXXXX"),
            jn((e = b())) ||
              m(
                "Unicode char: " +
                  e.charCodeAt(0) +
      ...
      return (
        ne(i) &&
          r &&
          ((n = i.charCodeAt(0).toString(16).toUpperCase()),
          (i = "\\u" + "0000".substr(n.length) + n + i.slice(1))),
        i
      );
    }
    var A = n("Unterminated regular expression", function (e) {
      for (var n, t = !1, i = !1; (n = f(!0)); )
        if (P(n)) m("Unexpected line terminator");
        else if (t) (e += "\\" + n), (t = !1);
        else if ("[" == n) (i = !0), (e += n);
        else if ("]" == n && i) (i = !1), (e += n);
        else {
    ...
    return (
      ...
      (D.add_directive = function (e) {
        u.directive_stack[u.directive_stack.length - 1].push(e),
          void 0 === u.directives[e]
            ? (u.directives[e] = 1)
            : u.directives[e]++;
      }),
      ...
      (D.pop_directives_stack = function () {
        for (
          var e = u.directive_stack[u.directive_stack.length - 1], n = 0;
          n < e.length;
          n++
        )
          u.directives[e[n]]--;
  ...
  var Ln = W(["typeof", "void", "delete", "--", "++", "!", "~", "-", "+"]),
    ...
    Jn = (function (e, n) {
      for (var t = 0; t < e.length; ++t)
        for (var i = e[t], r = 0; r < i.length; ++r) n[i[r]] = t + 1;
      return n;
    })(
      [
        ["||"],
  ...
  function Gn(e, u) {
    ...
    var c = {
      input:
        "string" == typeof e
          ? Un(e, u.filename, u.html5_comments, u.shebang)
          : e,
      token: null,
      prev: null,
      peeked: null,
    ...
    function p() {
      return (
        (c.prev = c.token),
        c.peeked
          ? ((c.token = c.peeked), (c.peeked = null))
          : (c.token = c.input()),
        (c.in_directives =
          c.in_directives && ("string" == c.token.type || f("punc", ";"))),
        c.token
      );
    }
    function d() {
    ...
    function v(e) {
      null == e && (e = c.token),
        t(e, "Unexpected token: " + e.type + " (" + e.value + ")");
    }
    function _(e, n) {
      if (f(e, n)) return p();
      t(
    ...
    function g(e) {
      return (
        e.nlb ||
        !oe(e.comments_before, function (e) {
          return !e.nlb;
        })
      );
    }
    ...
    function x() {
      (f("operator", "/") || f("operator", "/=")) &&
        ((c.peeked = null), (c.token = c.input(c.token.value.substr(1))));
    }
    c.token = p();
    var A = n(function (e) {
      switch ((x(), c.token.type)) {
        case "string":
          if (c.in_directives) {
            var n = l();
            -1 == c.token.raw.indexOf("\\") &&
            (In(n, "punc", ";") || In(n, "punc", "}") || g(n) || In(n, "eof"))
              ? c.input.add_directive(c.token.value)
              : (c.in_directives = !1);
          }
        ...
        case "name":
          return In(l(), "punc", ":")
            ? (function () {
                ...
                return new ve({ body: e, label: n });
              })()
            : E();
        case "punc":
          switch (c.token.value) {
            case "{":
              return new de({ start: c.token, body: F(), end: d() });
            case "[":
            case "(":
              return E();
            case ";":
        ...
        case "keyword":
          switch (c.token.value) {
            ...
            case "do":
              ...
              _("keyword", "while");
              var o = w();
              return y(!0), new ge({ body: r, condition: o });
            case "while":
              return p(), new be({ condition: w(), body: L(A) });
            case "for":
              return (
                p(),
                (function () {
                  ...
                  if (
                    !f("punc", ";") &&
                    ((e = f("keyword", "var") ? (p(), B(!0)) : U(!0, !0)),
                    f("operator", "in"))
                  )
                    return (
                      e instanceof Le
                        ? 1 < e.definitions.length &&
                          h(
                      ...
                      (t = U(!0)),
                      m(")"),
                      new we({ init: n, object: t, body: L(A) })
                    );
                  var n, t;
                  return (function (e) {
                    m(";");
                    ...
                    return (
                      m(")"),
                      new ye({ init: e, condition: n, step: t, body: L(A) })
                    );
                  })(e);
                })()
              );
            case "function":
              return (
                !e &&
                  c.input.has_directive("use strict") &&
                  h(
            ...
            case "if":
              return (
                ...
                (function () {
                  ...
                  return new Me({ condition: e, body: n, alternative: t });
                })()
              );
            case "return":
              0 != c.in_function ||
            ...
            case "switch":
              return p(), new qe({ expression: w(), body: L(C) });
            case "throw":
              p(), g(c.token) && h("Illegal newline after 'throw'");
              a = U(!0);
              return y(), new G({ value: a });
            case "try":
              return (
                p(),
                (function () {
                  ...
                  if (f("keyword", "finally")) {
                    var i = c.token;
                    p(), (t = new Pe({ start: i, body: F(), end: d() }));
                  }
                  n || t || h("Missing catch/finally blocks");
                  return new Re({ body: e, bcatch: n, bfinally: t });
                })()
              );
            case "var":
              p();
            ...
            case "with":
              return (
                c.input.has_directive("use strict") &&
                  h("Strict mode may not include a with statement"),
                p(),
                new xe({ expression: w(), body: A() })
              );
          }
      }
      v();
      ...
      b() || (t = q(ee, !0)),
        null != t
          ? ((n = V(function (e) {
            ...
            }, c.labels)) || h("Undefined label " + t.name),
            (t.thedef = n))
          : 0 == c.in_loop && h(e.TYPE + " not inside a loop or switch"),
        y();
      var i = new e({ label: t });
    ...
    var D = function (e) {
      ...
      ++c.in_function,
        (c.in_directives = !0),
        c.input.push_directives_stack(),
        (c.in_loop = 0),
        (c.labels = []);
      var s = F(!0);
      return (
        c.input.has_directive("use strict") && (t && M(t), i.forEach(M)),
        c.input.pop_directives_stack(),
        --c.in_function,
        (c.in_loop = o),
        (c.labels = a),
        new e({ name: t, argnames: i, body: s })
      );
    };
    function F(e) {
      m("{");
      for (var n = []; !f("punc", "}"); ) f("eof") && v(), n.push(A(e));
      return p(), n;
    }
    function C() {
      m("{");
      for (var e, n = [], t = null, i = null; !f("punc", "}"); )
        f("eof") && v(),
          f("keyword", "case")
            ...
            ? (i && (i.end = d()),
              (t = []),
              (i = new Ne({ start: ((e = c.token), p(), m(":"), e), body: t })),
              n.push(i))
            : (t || v(), t.push(A()));
      ...
      if (f("operator", "new"))
        return (function (e) {
          ...
          var t,
            i = s(!1);
          f("punc", "(") ? (p(), (t = S(")"))) : (t = []);
          var r = new Je({ start: n, expression: i, args: t, end: d() });
          return j(r), N(r, e);
        })(e);
      var n = c.token;
      if (f("punc")) {
        switch (n.value) {
          case "(":
            ...
            if (
              ...
              0 == (n.comments_before_length = i) &&
                0 < n.comments_before.length)
            ) {
            ...
            var o = d();
            return (
              (o.comments_before = t.end.comments_before),
              [].push.apply(t.end.comments_after, o.comments_after),
              (o.comments_after = t.end.comments_after),
              (t.end = o),
              t instanceof Ye && j(t),
              N(t, e)
            );
          ...
          (function () {
            ...
            switch (n.type) {
              ...
              case "string":
                ...
                break;
              case "regexp":
                e = new wn({ start: n, end: n, value: n.value });
                break;
              case "atom":
                switch (n.value) {
                  case "false":
                    e = new Cn({ start: n, end: n });
                    break;
                  case "true":
                    e = new Bn({ start: n, end: n });
                    break;
                  case "null":
                    e = new xn({ start: n, end: n });
                }
            }
            return p(), e;
          })(),
    ...
    function S(e, n, t) {
      for (
        var i = !0, r = [];
        !f("punc", e) && (i ? (i = !1) : m(","), !n || !f("punc", e));

      )
        f("punc", ",") && t
          ? r.push(new kn({ start: c.token, end: c.token }))
          : r.push(U(!1));
      return p(), r;
    }
    var T = n(function () {
        return m("["), new on({ elements: S("]", !u.strict, !0) });
      }),
      a = n(function () {
        return D(De);
      }),
      O = n(function () {
        ...
        for (
          ...
          var t = c.token,
            ...
            r = $();
          if ("name" == i && !f("punc", ":")) {
            var o = new K({ start: c.token, name: "" + $(), end: d() });
            if ("get" == r) {
              n.push(new Z({ start: t, key: o, value: a(), end: d() }));
              continue;
            }
            if ("set" == r) {
              n.push(new X({ start: t, key: o, value: a(), end: d() }));
              continue;
            }
          }
          m(":"),
    ...
    function M(e) {
      ("arguments" != e.name && "eval" != e.name) ||
        h(
          "Unexpected " + e.name + " in strict mode",
          e.start.line,
          e.start.col,
          e.start.pos
        );
    ...
    function q(e, n) {
      ...
      var t = z(e);
      return (
        c.input.has_directive("use strict") && t instanceof fn && M(t), p(), t
      );
    }
    function j(e) {
      for (
    ...
    var N = function (e, n) {
          ...
          return (
            ...
            N(
              new Xe({
                ...
                expression: e,
                property:
                  ((t = c.token), "name" != t.type && v(), p(), t.value),
                end: d(),
              }),
              n
            )
        ...
        if (f("punc", "[")) {
          ...
          return (
            m("]"),
            N(new Ze({ start: i, expression: e, property: r, end: d() }), n)
          );
        }
        if (n && f("punc", "(")) {
          p();
          var o = new Ye({ start: i, expression: e, args: S(")"), end: d() });
          return j(o), N(o, !0);
        }
        return e;
      },
    ...
    function r(e, n, t) {
      ...
      return new e({ operator: i, expression: t });
    }
    ...
    var P = function (e) {
        ...
        if (f("operator") && Yn(i)) {
          if (I(t))
            return (
              p(),
              new rn({ start: n, left: t, operator: i, right: P(e), end: d() })
            );
      ...
      U = function (e, n) {
        ...
        return 1 == i.length
          ? i[0]
          : new We({ start: t, expressions: i, end: l() });
      };
    function L(e) {
      ++c.in_loop;
      var n = e();
    ...
    return u.expression
      ...
      : (function () {
          var e = c.token,
            n = [];
          for (c.input.push_directives_stack(); !f("eof"); ) n.push(A(!0));
          c.input.pop_directives_stack();
          var t = d(),
            i = u.toplevel;
          return (
            i
              ? ((i.body = i.body.concat(n)), (i.end = t))
              : (i = new Ee({ start: e, body: n, end: t })),
            i
          );
        })();
  }
  ...
  function p(e, n) {
    ...
    return (
      t ||
        ((e.names_in_use = t = Object.create(e.mangled_names || null)),
        (e.cname_holes = []),
  ...
  function f(e) {
    return (
      ...
      Array.isArray(e.reserved) || (e.reserved = []),
      v(e.reserved, "arguments"),
      e
    );
  }
  (Xn.prototype = new Sn()),
    (function (o) {
      function e(e, r) {
        e.DEFMETHOD("transform", function (e, n) {
          ...
          return (
            e.push(this),
            e.before && (t = e.before(this, r, n)),
            t === o &&
              (r((t = this), e),
              e.after && (i = e.after(t, n)) !== o && (t = i)),
            e.pop(),
            t
          );
        });
      ...
      e(se, L),
        ...
        e(ye, function (e, n) {
          e.init && (e.init = e.init.transform(n)),
            e.condition && (e.condition = e.condition.transform(n)),
            e.step && (e.step = e.step.transform(n)),
            (e.body = e.body.transform(n));
        }),
        e(we, function (e, n) {
        ...
        e(Me, function (e, n) {
          (e.condition = e.condition.transform(n)),
            (e.body = e.body.transform(n)),
            e.alternative && (e.alternative = e.alternative.transform(n));
        }),
        e(qe, function (e, n) {
        ...
        e(Re, function (e, n) {
          (e.body = t(e.body, n)),
            e.bcatch && (e.bcatch = e.bcatch.transform(n)),
            e.bfinally && (e.bfinally = e.bfinally.transform(n));
        }),
        e(Ie, function (e, n) {
        ...
        e(ke, function (e, n) {
          e.name && (e.name = e.name.transform(n)),
      ...
      unmangleable: function (e) {
        return (
          ...
          (this.global && !e.toplevel) ||
            ...
            (e.keep_fnames &&
              (this.orig[0] instanceof hn || this.orig[0] instanceof dn))
        );
      },
      mangle: function (e) {
        ...
        if (this.global && n && n.has(this.name))
          ...
          (t = this.redefined())
            ...
            : (this.mangled_name = (function (e, i, n) {
                var t = p(e, i),
                  r = e.cname_holes,
                ...
                n.references.forEach(function (e) {
                  ...
                  do {
                    ...
                    for (var t in p(n, i)) o[t] = !0;
                    u.push(n);
                  } while ((n = n.parent_scope));
                });
                for (var c = 0, f = r.length; c < f; c++)
                  if (((s = g(r[c])), !o[s]))
                    return r.splice(c, 1), (e.names_in_use[s] = !0), s;
                for (;;)
                  if (
                    ((s = g(++e.cname)), !t[s] && l(s) && !te(s, i.reserved))
                  ) {
                    if (!o[s]) break;
                    r.push(e.cname);
                  }
                (e.names_in_use[s] = !0),
                  i.ie8 &&
                    n.orig[0] instanceof hn &&
                    (p(e.parent_scope, i)[s] = !0);
                return s;
              })(this.scope, e, this)),
            this.global && n && n.set(this.name, this.mangled_name);
        }
      },
      redefined: function () {
    ...
    Ee.DEFMETHOD("figure_out_scope", function (c) {
        ...
        s = new Sn(function (e, n) {
          ...
          if (e instanceof Ae) {
            ...
            var i = p,
              r = l;
            return (
              (p = f = e), (l = new O()), n(), (f = t), (p = i), (l = r), !0
            );
          }
          if (e instanceof ve) {
            var o = e.label;
            if (l.has(o.name))
              throw new Error(S("Label {name} defined twice", o));
            return l.set(o.name, o), n(), l.del(o.name), !0;
          }
          if (e instanceof xe)
            for (var a = f; a; a = a.parent_scope) a.uses_with = !0;
          else if (
            (e instanceof cn && (e.scope = f),
            e instanceof Q && ((e.thedef = e).references = []),
            e instanceof hn)
          )
            p.def_function(e, "arguments" == e.name ? void 0 : p);
          else if (e instanceof dn)
            (e.scope = p.parent_scope).def_function(e, p);
          else if (e instanceof ln) {
            if (
              (p.def_variable(e, "SymbolVar" == e.TYPE ? null : void 0),
              p !== f)
            ) {
              e.mark_enclosed(c);
          ...
          } else if (e instanceof vn) f.def_variable(e).defun = p;
          else if (e instanceof ee) {
            var u = l.get(e.name);
            if (!u)
              throw new Error(
                S("Undefined label {name} [{line},{col}]", {
                  name: e.name,
                  line: e.start.line,
                  col: e.start.col,
                })
      ...
      s = new Sn(function (e, n) {
        if (e instanceof Oe && e.label)
          return e.label.thedef.references.push(e), !0;
        if (e instanceof _n) {
          var t = e.name;
          if ("eval" == t && s.parent() instanceof Ye)
            for (var i = e.scope; i && !i.uses_eval; i = i.parent_scope)
              i.uses_eval = !0;
          var r = e.scope.find_variable(t);
          return (
            r
              ? r.scope instanceof ke &&
                "arguments" == t &&
                (r.scope.uses_arguments = !0)
              : (r = a.def_global(e)),
            (e.thedef = r),
            e.reference(c),
            !0
        ...
        var o;
        if (e instanceof vn && (o = e.definition().redefined()))
          for (i = e.scope; i && (v(i.enclosed, o), i !== o.scope); )
            i = i.parent_scope;
      });
      a.walk(s),
        c.ie8 &&
            ...
            new Sn(function (e, n) {
              if (e instanceof vn) {
                var t = e.name,
                  ...
                  r = e.thedef.defun,
                  o =
                    r.find_variable(t) || a.globals.get(t) || r.def_variable(e);
                return (
    ...
    ke.DEFMETHOD("init_scope_vars", function () {
      Ae.prototype.init_scope_vars.apply(this, arguments),
        (this.uses_arguments = !1),
        this.def_variable(
          new pn({ name: "arguments", start: this.start, end: this.end })
        );
    }),
    cn.DEFMETHOD("mark_enclosed", function (e) {
      for (
        var n = this.definition(), t = this.scope;
        t &&
        (v(t.enclosed, n),
        e.keep_fnames &&
    ...
    Ae.DEFMETHOD("def_function", function (e, n) {
      ...
      return (
        (!t.init || t.init instanceof Ce) && (t.init = n),
    ...
    Ae.DEFMETHOD("def_variable", function (e, n) {
      ...
      return (
        t
          ? (t.orig.push(e),
            t.init &&
              (t.scope !== e.scope || t.init instanceof Fe) &&
              (t.init = n))
          : ((t = new r(this, e, n)),
    ...
    Q.DEFMETHOD("unmangleable", ie),
    cn.DEFMETHOD("unreferenced", function () {
      return (
      ...
      var u = [],
        e = new Sn(function (e, n) {
          ...
          if (e instanceof Ae)
            return (
              n(),
              a.cache && e instanceof Ee && e.globals.each(c),
              e.variables.each(c),
              !0
            );
          if (e instanceof Q) {
    ...
    Ee.DEFMETHOD("find_colliding_names", function (t) {
      ...
      return (
        ...
        this.walk(
          new Sn(function (e) {
            e instanceof Ae && e.variables.each(o),
              e instanceof vn && o(e.definition());
          })
        ),
        n
      );
      ...
      function o(e) {
        var n = e.name;
        if (e.global && i && i.has(n)) n = i.get(n);
        else if (!e.unmangleable(t)) return;
        r(n);
      }
    }),
    Ee.DEFMETHOD("expand_names", function (t) {
      ...
      this.globals.each(n),
        this.walk(
          new Sn(function (e) {
            e instanceof Ae && e.variables.each(n),
              e instanceof vn && n(e.definition());
          })
        );
    }),
    se.DEFMETHOD("tail_node", C),
    ...
    Ee.DEFMETHOD("compute_char_frequency", function (t) {
      ...
      try {
        (se.prototype.print = function (e, n) {
          this._print(e, n),
            this instanceof cn && !this.unmangleable(t)
              ? g.consider(this.name, -1)
              : t.properties &&
                (this instanceof Xe
                  ? g.consider(this.property, -1)
                  : this instanceof Ze &&
                    (function e(n) {
                      n instanceof bn
                        ? g.consider(n.value, -1)
                        : n instanceof tn
                        ? (e(n.consequent), e(n.alternative))
                        : n instanceof We && e(n.tail_node());
                    })(this.property));
        }),
  ...
  var g = (function () {
      ...
      function a(e) {
        ...
        for (
          e++;
          (n += i[--e % t]), (e = Math.floor(e / t)), (t = 64), 0 < e;
      ...
      return (
        (a.consider = function (e, n) {
          for (var t = e.length; 0 <= --t; ) r[e[t]] += n;
        }),
        (a.sort = function () {
  ...
  function Qn(s) {
    ...
    if (s.comments) {
      var n = s.comments;
      if (
        "string" == typeof s.comments &&
        /^\/.*\/[a-zA-Z]*$/.test(s.comments)
      ) {
            ...
            x.forEach(function (n) {
              try {
                s.source_map.add(
                  ...
                  n.token.line,
                  n.token.col,
                  n.name || "name" != n.token.type ? n.name : n.token.value
                );
              } catch (e) {
                se.warn(
      ...
      E = s.max_line_len
        ? function () {
            if (a > s.max_line_len) {
              ...
              a > s.max_line_len &&
                se.warn("Output exceeds {max_line_len} characters", s);
            }
            m && ((m = 0), A());
          }
        : L,
          ...
          ((":" == t && "}" == n) ||
            ...
            (s.semicolons || k(n)
              ...
              : (E(),
                ...
                /^\s+$/.test(e) && (_ = !0)),
            s.beautify || (v = !1))),
        !s.beautify && s.preserve_line && q[q.length - 1])
      )
        for (var i = q[q.length - 1].start.line; c < i; )
          E(), (l += "\n"), f++, c++, (a = 0), (v = !1);
      v &&
        (((jn(t) && (jn(n) || "\\" == n)) ||
          ("/" == n && n == t) ||
        ...
        (v = !1)),
        d &&
          (x.push({ token: d, name: h, line: c, col: a }), (d = !1), m || A()),
        (l += e),
        (f += e.length);
      var r = e.split(/\r?\n/),
        o = r.length - 1;
      ...
      prepend_comments: e
        ...
        : function (e) {
            ...
            if (n && (!n.comments_before || n.comments_before._dumped !== i)) {
              ...
              if (
                (r || (r = n.comments_before = []),
                (r._dumped = i),
                e instanceof Se && e.value)
              ) {
                var o = new Sn(function (e) {
                  ...
                  if (
                    !(
                      n instanceof Se ||
                      (n instanceof nn && n.left === e) ||
                      ("Call" == n.TYPE && n.expression === e) ||
                      (n instanceof tn && n.condition === e) ||
                      (n instanceof Xe && n.expression === e) ||
                      (n instanceof We && n.expressions[0] === e) ||
                      (n instanceof Ze && n.expression === e) ||
                      n instanceof en
                    )
                  )
                    return !0;
              ...
              if (0 != (r = r.filter(u, e)).length) {
                ...
                r.forEach(function (e, n) {
                  a || (e.nlb ? (D("\n"), C(), (a = !0)) : 0 < n && F()),
                    /comment[134]/.test(e.type)
                      ? (D("//" + e.value.replace(/[@#]__PURE__/g, " ") + "\n"),
                        C(),
                        (a = !0))
                      : "comment2" == e.type &&
                        (D("/*" + e.value.replace(/[@#]__PURE__/g, " ") + "*/"),
  ...
  function et(e, n) {
    ...
    Xn.call(this, this.before, this.after),
      (this.options = Y(
        e,
        {
          arguments: !n,
    ...
    if ("object" == typeof t)
      for (var i in t)
        /^@/.test(i) &&
          ae(t, i) &&
          (t[i.slice(1)] = Gn(t[i], { expression: !0 }));
    ...
    this.toplevel =
      "string" == typeof a
        ? { funcs: /funcs/.test(a), vars: /vars/.test(a) }
        : { funcs: a, vars: a };
    var s = this.options.sequences;
    (this.sequences_limit = 1 == s ? 800 : 0 | s),
      ...
      new Sn(function (e) {
        return (
          e instanceof We
            ...
            : e instanceof bn
            ? n(e.value)
            : e instanceof tn && (b(e.consequent, n), b(e.alternative, n)),
          !0
        );
      })
    );
  ...
  function d(e, n) {
    ...
    var i,
      r = -1;
    n.cache
      ? (i = n.cache.props).each(function (e) {
          v(t, e);
        })
      : (i = new O());
    var o,
      ...
      e.walk(
        new Sn(function (e) {
          e instanceof un
            ...
            : e instanceof Xe
            ? p(e.property)
            : e instanceof Ze && b(e.property, p);
        })
      ),
      e.transform(
        new Xn(function (e) {
  ...
  !(function () {
      ...
      (o = n),
        e.forEach(function (e, n) {
          !0 !== o ||
            e instanceof fe ||
            e instanceof he ||
            (e instanceof le && e.body instanceof bn) ||
            (o = !1),
            e instanceof he ||
              (i.indent(),
              e.print(i),
              (n == r && t) || (i.newline(), t && i.newline())),
            !0 === o && e instanceof le && e.body instanceof bn && (o = !1);
        }),
        (o = !1);
    }
    function r(e, n) {
      ...
      t &&
        e.walk(
          new Sn(function (e) {
            return (
              !!(i || e instanceof Ae) ||
              (e instanceof nn && "in" == e.operator ? (i = !0) : void 0)
            );
          })
        ),
        e.print(n, i);
    ...
    function f(e, n, t) {
      t.option("quote_keys")
        ...
        : "" + +e == e && 0 <= e
        ? t.print(d(e))
        : (m(e) ? !t.option("ie8") : Nn(e))
        ? n && t.option("keep_quoted_props")
          ? t.print_string(e, n)
          : t.print_name(e)
        : t.print_string(e, n);
    }
      ...
      return (
        Math.floor(e) === e
          ? (0 <= e
            ...
            (n = /^(.*?)(0+)$/.exec(e)) && i.push(n[1] + "e" + n[2].length))
          : (n = /^0?\.(0+)(.*)$/.exec(e)) &&
            i.push(
    ...
    se.DEFMETHOD("print", function (e, n) {
      ...
      t instanceof Ae
        ? (a = t)
        : !s && t instanceof fe && "use asm" == t.value && (s = a),
        e.push_node(t),
        n || t.needs_parens(e) ? e.with_parens(r) : r(),
        e.pop_node(),
        t === s && (s = null);
    }),
      se.DEFMETHOD("_print", se.prototype.print),
      se.DEFMETHOD("print_to_string", function (e) {
        var n = Qn(e);
      ...
      t(Fe, function (e) {
        ...
        if (
          e.option("webkit") &&
          (n = e.parent()) instanceof Ge &&
          n.expression === this
        )
          return !0;
        return (
          !!e.option("wrap_iife") &&
          (n = e.parent()) instanceof Ye &&
          n.expression === this
        );
      }),
      t(an, function (e) {
      ...
      t(Ke, function (e) {
        var n = e.parent();
        return (
          (n instanceof Ge && n.expression === this) ||
          (n instanceof Ye && n.expression === this)
        );
      }),
      t(We, function (e) {
        var n = e.parent();
      ...
      t(Ye, function (e) {
        var n,
          t = e.parent();
        return (
          (t instanceof Je && t.expression === this) ||
          (this.expression instanceof Fe &&
            t instanceof Ge &&
            t.expression === this &&
            (n = e.parent(1)) instanceof rn &&
            n.left === t)
        );
      }),
      t(Je, function (e) {
        ...
        if (
          !p(this, e) &&
          (n instanceof Ge || (n instanceof Ye && n.expression === this))
        )
          return !0;
      }),
      t(yn, function (e) {
      ...
      t([rn, tn], function (e) {
        ...
        return (
          n instanceof Ke ||
          (n instanceof nn && !(n instanceof rn)) ||
          (n instanceof Ye && n.expression === this) ||
          (n instanceof tn && n.condition === this) ||
          (n instanceof Ge && n.expression === this) ||
          void 0
        );
      }),
      ...
      e(ye, function (e, n) {
        n.print("for"),
          ...
          n.with_parens(function () {
            e.init
              ? (e.init instanceof Ue ? e.init.print(n) : c(e.init, n, !0),
                n.print(";"),
                n.space())
              : n.print(";"),
              e.condition
                ? (e.condition.print(n), n.print(";"), n.space())
                : n.print(";"),
              e.step && e.step.print(n);
          }),
          n.space(),
          e._do_print_body(n);
      }),
      ...
      e(Me, function (e, n) {
        n.print("if"),
          ...
          e.alternative
            ? (!(function (e, n) {
                var t = e.body;
                if (n.option("braces") || (n.option("ie8") && t instanceof ge))
                  return h(t, n);
      ...
      e(Re, function (e, n) {
        n.print("try"),
          n.space(),
          u(e, n),
          e.bcatch && (n.space(), e.bcatch.print(n)),
          e.bfinally && (n.space(), e.bfinally.print(n));
      }),
      e(Ie, function (e, n) {
        n.print("catch"),
          n.space(),
      ...
      Ue.DEFMETHOD("_do_print", function (t, e) {
        t.print(e),
          t.space(),
          this.definitions.forEach(function (e, n) {
            n && t.comma(), e.print(t);
          });
        var n = t.parent();
        ((n instanceof ye || n instanceof we) && n.init === this) ||
          t.semicolon();
      }),
      e(Le, function (e, n) {
        e._do_print(n, "var");
      ...
      e(Ye, function (e, t) {
        e.expression.print(t),
          (e instanceof Je && !p(e, t)) ||
            ((e.expression instanceof Ye || e.expression instanceof ke) &&
      ...
      We.DEFMETHOD("_do_print", function (t) {
        this.expressions.forEach(function (e, n) {
          0 < n && (t.comma(), t.should_break() && (t.newline(), t.indent())),
            e.print(t);
        });
      }),
      e(We, function (e, n) {
      ...
      e(nn, function (e, n) {
        var t = e.operator;
        e.left.print(n),
          ">" == t[0] && e.left instanceof en && "--" == e.left.operator
            ? n.print(" ")
            : n.space(),
          n.print(t),
          ("<" == t || "<<" == t) &&
          ...
          "!" == e.right.operator &&
          e.right.expression instanceof Qe &&
      ...
      sn.DEFMETHOD("_print_getter_setter", function (e, n) {
        n.print(e),
          n.space(),
          f(this.key.name, this.quote, n),
          this.value._do_print(n, !0);
      }),
      e(X, function (e, n) {
      ...
      e(wn, function (e, n) {
        var t = e.getValue(),
          i = t.toString();
        t.raw_source && (i = "/" + t.raw_source + i.slice(i.lastIndexOf("/"))),
          (i = n.to_utf8(i)),
          n.print(i);
        var r = n.parent();
        r instanceof nn &&
    ...
    t((et.prototype = new Xn()), {
      ...
      exposed: function (e) {
        if (e.global)
          for (var n = 0, t = e.orig.length; n < t; n++)
            if (!this.toplevel[e.orig[n] instanceof dn ? "funcs" : "vars"])
              return !0;
        return !1;
      },
      compress: function (e) {
        ...
        for (
          ...
          if (
            ...
            (0 < o || this.option("reduce_vars")) && e.reset_opt_flags(this),
            (e = e.transform(this)),
            1 < n)
          ) {
            var a = 0;
      ...
      warn: function (e, n) {
        if (this.options.warnings) {
          var t = S(e, n);
          t in this.warnings_produced ||
            ((this.warnings_produced[t] = !0), se.warn.apply(se, arguments));
        }
      },
      ...
      before: function (e, n, t) {
        ...
        return (
          i && r instanceof Ae && (r.drop_unused(this), n(r, this)),
          r === e && (r._squeezed = !0),
          r
        );
      },
    ...
    (function () {
      ...
      function X(e, n, t) {
        return (
          t || (t = {}),
          n && (t.start || (t.start = n.start), t.end || (t.end = n.end)),
          new e(t)
        );
      }
      function M(e, n) {
        return 1 == n.length
          ? n[0]
          : X(We, e, { expressions: n.reduce(l, []) });
      }
      function q(e, n) {
        switch (typeof e) {
          case "string":
            return X(bn, n, { value: e });
          case "number":
            return isNaN(e)
              ? X(An, n)
              : isFinite(e)
              ? 1 / e < 0
                ? X(Qe, n, {
                    operator: "-",
                    expression: X(yn, n, { value: -e }),
                  })
                : X(yn, n, { value: e })
              : e < 0
              ? X(Qe, n, { operator: "-", expression: X(Dn, n) })
              : X(Dn, n);
          case "boolean":
            return X(e ? Bn : Cn, n);
          case "undefined":
            return X(En, n);
          default:
            if (null === e) return X(xn, n, { value: null });
            if (e instanceof RegExp) return X(wn, n, { value: e });
            throw new Error(
              S("Can't handle constant of type: {type}", { type: typeof e })
            );
        }
      }
      function Z(e, n, t) {
        return (e instanceof Qe && "delete" == e.operator) ||
          (e instanceof Ye &&
            e.expression === n &&
            (t instanceof Ge || (t instanceof _n && "eval" == t.name)))
          ? M(n, [X(yn, n, { value: 0 }), t])
          : t;
      }
      function l(e, n) {
      ...
      function j(e) {
        return (
          null === e ||
          e instanceof he ||
          (e instanceof de && 0 == e.body.length)
        );
      }
      function y(e) {
      ...
      function K(e) {
        for (; e instanceof Ge; ) e = e.expression;
        return e;
      }
      function N(e) {
        return (
          "Call" == e.TYPE && (e.expression instanceof Fe || N(e.expression))
        );
      }
      function H(e) {
      ...
      e(se, function (e, n) {
        ...
        Ae.DEFMETHOD("process_expression", function (i, r) {
          var o = this,
            a = new Xn(function (e) {
              if (i && e instanceof le) return X(Te, e, { value: e.body });
              if (!i && e instanceof Te) {
                if (r) {
                  var n = e.value && e.value.drop_side_effect_free(r, !0);
                  return n ? X(le, e, { body: n }) : X(he, e);
                }
                return X(le, e, {
                  body:
                    e.value ||
        ...
        (function (e) {
          function i(e, n) {
            (n.assignments = 0),
              ...
              (n.direct_access = !1),
              (n.escaped = !1),
              n.scope.uses_eval || n.scope.uses_with
                ? (n.fixed = !1)
                : e.exposed(n)
                ? (n.fixed = !1)
                : (n.fixed = n.init),
          ...
          function a(n, t, e) {
            e.variables.each(function (e) {
              i(t, e),
                null === e.fixed
                  ? ((e.safe_ids = n.safe_ids), c(n, e, !0))
                  : e.fixed && ((n.loop_ids[e.id] = n.in_loop), c(n, e, !0));
            });
          }
          function s(e) {
          ...
          function o(e, n, t) {
            return (
              void 0 === n.fixed ||
              (null === n.fixed && n.safe_ids
                ? ((n.safe_ids[n.id] = !1), delete n.safe_ids, !0)
                : !!ae(e.safe_ids, n.id) &&
                  !!f(e, n) &&
                  !1 !== n.fixed &&
                  !(
                    null != n.fixed &&
                    (!t || n.references.length > n.assignments)
                  ) &&
                  oe(n.orig, function (e) {
          ...
          e(De, function (e, n, t) {
            ...
            e(rn, function (e) {
              ...
              if (n.left instanceof _n) {
                var t = n.left.definition(),
                  i = t.fixed;
                if ((i || "=" == n.operator) && o(e, t, n.right))
                  return (
                    t.references.push(n.left),
                    t.assignments++,
                    "=" != n.operator && (t.chained = !0),
                    (t.fixed =
                      "=" == n.operator
                        ? function () {
                            return n.right;
            ...
            e(nn, function (e) {
              if (ee(this.operator))
                return this.left.walk(e), s(e), this.right.walk(e), u(e), !0;
            }),
            e(He, function (e) {
              return (
                s(e), this.expression.walk(e), u(e), s(e), z(this, e), u(e), !0
              );
            }),
            e(tn, function (e) {
              return (
            ...
            e(ye, function (e) {
              ...
              var n = e.in_loop;
              return (
                (e.in_loop = this).condition &&
                  (s(e), this.condition.walk(e), u(e)),
                s(e),
                this.body.walk(e),
                u(e),
                this.step && (s(e), this.step.walk(e), u(e)),
                (e.in_loop = n),
                !0
              );
            }),
            ...
            e(Fe, function (i, e, n) {
              ...
              return (
                ...
                a(i, n, o),
                !o.name &&
                  (r = i.parent()) instanceof Ye &&
                  r.expression === o &&
                  o.argnames.forEach(function (e, n) {
                    var t = e.definition();
                    o.uses_arguments || void 0 !== t.fixed
                      ? (t.fixed = !1)
                      : ((t.fixed = function () {
            ...
            e(Me, function (e) {
              return (
                ...
                this.body.walk(e),
                u(e),
                this.alternative && (s(e), this.alternative.walk(e), u(e)),
                !0
              );
            }),
            e(ve, function (e) {
            ...
            e(_n, function (e, n, t) {
              var i,
                ...
                a,
                s = this.definition();
              s.references.push(this),
                1 == s.references.length &&
                  !s.fixed &&
                  s.orig[0] instanceof dn &&
                  (e.loop_ids[s.id] = e.in_loop),
                void 0 !== s.fixed && f(e, s) && "m" != s.single_use
                  ? s.fixed &&
                    ((i = this.fixed_value()) instanceof ke && P(e, s)
                      ? s.recursive_refs++
                      : i &&
                        ((o = e),
                        (a = s),
                        t.option("unused") &&
                          !a.scope.uses_eval &&
                          !a.scope.uses_with &&
                          a.references.length - a.recursive_refs == 1 &&
                          o.loop_ids[a.id] === o.in_loop)
                      ? (s.single_use =
                          i instanceof ke ||
                          (s.scope === this.scope &&
                            i.is_constant_expression()))
                      : (s.single_use = !1),
                    (function e(n, t, i, r, o) {
                      ...
                      if (
                        ...
                        (!o &&
                          ...
                          a.expression === t &&
                          (!(i instanceof Fe) ||
                            (!(a instanceof Je) && i.contains_this())))
                      )
                        return !0;
                      ...
                      return a instanceof Ge && a.expression === t
                        ? !o && e(n, a, l(i, a.property), r + 1)
                        : void 0;
                    })(
                      e,
                      this,
                      ...
                      0,
                      !!(r = i) &&
                        (r.is_constant() || r instanceof ke || r instanceof mn)
                    ) && (s.single_use ? (s.single_use = "m") : (s.fixed = !1)))
                  : (s.fixed = !1),
                (function e(n, t, i, r, o, a, s) {
                  var u = n.parent(a);
                  if (!o || !o.is_constant()) {
                    if (
                      (u instanceof rn && "=" == u.operator && r === u.right) ||
                      (u instanceof Ye && r !== u.expression) ||
                      (u instanceof Se &&
                        r === u.value &&
                        r.scope !== t.scope) ||
                      (u instanceof Ve && r === u.value)
                    )
                      return (
                        !(1 < s) ||
                          (o && o.is_constant_expression(i)) ||
                          (s = 1),
                        void ((!t.escaped || t.escaped > s) && (t.escaped = s))
                      );
                    if (
                      u instanceof on ||
                      (u instanceof nn && ee(u.operator)) ||
                      (u instanceof tn && r !== u.condition) ||
                      (u instanceof We && r === u.tail_node())
                    )
                      e(n, t, i, u, u, a + 1, s);
                    else if (u instanceof un && r === u.value) {
                      var c = n.parent(a + 1);
                      e(n, t, i, c, c, a + 2, s);
                    } else if (
                      u instanceof Ge &&
                      r === u.expression &&
                      (e(n, t, i, u, (o = l(o, u.property)), a + 1, s + 1), o)
                    )
                      return;
            ...
            e(Re, function (e) {
              return (
                ...
                z(this, e),
                u(e),
                this.bcatch && (s(e), this.bcatch.walk(e), u(e)),
                this.bfinally && this.bfinally.walk(e),
                !0
              );
            }),
            e(Ke, function (e, n) {
              ...
              if (
                ...
                t.expression instanceof _n
              ) {
                var i = t.expression.definition(),
                  r = i.fixed;
                if (r && o(e, i, !0))
                  return (
                    i.references.push(t.expression),
                    i.assignments++,
                    (i.chained = !0),
                    (i.fixed = function () {
                      return X(nn, t, {
        ...
        Ee.DEFMETHOD("reset_opt_flags", function (t) {
          var i = t.option("reduce_vars"),
            r = new Sn(function (e, n) {
              if (((e._squeezed = !1), (e._optimized = !1), i))
      ...
      _n.DEFMETHOD("is_declared", function (e) {
        return (
          !this.definition().undeclared || (e.option("unsafe") && n(this.name))
        );
      });
      var t,
        i,
      ...
      function u(e, c) {
        ...
        !(function () {
          var e = c.self(),
            n = 0;
          do {
            if (e instanceof Ie || e instanceof Pe) n++;
            else if (e instanceof _e) V = !0;
            else {
              if (e instanceof Ae) {
                J = e;
                break;
        ...
        for (
          ...
          (W = !1),
            r(e),
            c.option("dead_code") && o(e, c),
            c.option("if_return") && i(e, c),
            0 < c.sequences_limit && (a(e, c), s(e, c)),
            c.option("join_vars") && u(e),
            c.option("collapse_vars") && t(e, c),
            W && 0 < n--;
        ...
        function t(t, c) {
          ...
          for (
            var f,
              ...
              a = new Xn(
                function (e) {
                    ...
                    return e !== s[u]
                      ...
                      : ((k = !0),
                        (h = (function e(n, t, i) {
                          ...
                          if (r instanceof rn)
                            return i &&
                              !(r.left instanceof Ge || (r.left.name in y))
                              ? e(r, t + 1, i)
                              : n;
                          if (r instanceof nn)
                            return !i || (ee(r.operator) && r.left !== n)
                              ? n
                              : e(r, t + 1, i);
                          if (r instanceof Ye) return n;
                          if (r instanceof He) return n;
                          if (r instanceof tn)
                            return i && r.condition === n ? e(r, t + 1, i) : n;
                  ...
                  if (
                    (e instanceof rn &&
                      "=" != e.operator &&
                      _.equivalent_to(e.left)) ||
                    (e instanceof Ye &&
                      _ instanceof Ge &&
                      _.equivalent_to(e.expression)) ||
                    e instanceof ce ||
                    (e instanceof _e && !(e instanceof ye)) ||
                    e instanceof Oe ||
                    e instanceof Re ||
                    e instanceof xe ||
                    (i instanceof ye && e !== i.init) ||
                    (!x && e instanceof _n && !e.is_declared(c))
                  )
                    return (D = !0), e;
                  if (
                    (!v &&
                      ((i instanceof nn && ee(i.operator) && i.left !== e) ||
                        (i instanceof tn && i.condition !== e) ||
                        (i instanceof Me && i.condition !== e)) &&
                      (v = i),
                    C &&
                      !(e instanceof fn) &&
                      ((g && _.equivalent_to(e)) || (b && (n = b(e, this)))))
                  ) {
                    ...
                    if (
                      ((W = D = !0),
                      F++,
                      c.info("Collapsing {name} [{file}:{line},{col}]", {
                    ...
                    if (p instanceof Ve) {
                      ...
                      var r = p.name.definition(),
                        o = p.value;
                      return r.references.length - r.replaced != 1 ||
                        c.exposed(r)
                        ? X(rn, p, {
                            operator: "=",
                        ...
                        : (r.replaced++,
                          E && Q(o) ? o.transform(c) : Z(i, e, o));
                    }
                    return (p.write_only = !1), p;
                  }
                  return (
                    (e instanceof Ye ||
                      (e instanceof Se && (m || _ instanceof Ge || L(_))) ||
                      (e instanceof Ge &&
                        (m || e.expression.may_throw_on_access(c))) ||
                      (e instanceof _n &&
                        ((function (e) {
                          var n = y[e.name];
                          if (!n) return;
                      ...
                      (e instanceof Ve &&
                        e.value &&
                        ((e.name.name in y) || (m && L(e.name)))) ||
                      ((t = ne(e.left, e)) &&
                        (t instanceof Ge || (t.name in y))) ||
                      (A &&
                        (Y
                          ? e.has_side_effects(c)
                          : (function e(n, t) {
              ...
              i = new Xn(function (e) {
                ...
                return e instanceof _n && e.name == T.name
                  ? (--F || (D = !0),
                    ne(e, i.parent())
                      ? e
                      : (T.replaced++, d.replaced--, p.value))
                  : e instanceof Ne || e instanceof Ae
                  ? e
                  : void 0;
              });
            0 <= --o;
            ...
            for (z(t[o]); 0 < l.length; ) {
              ...
              if (g || b) {
                var y = R(p),
                  w =
                    ((n = void 0),
                    (n = K((e = _))) instanceof _n &&
                      n.definition().scope === J &&
                      !(
                        V &&
                        ((n.name in y && y[n.name] !== e) ||
                          p instanceof Ke ||
                          (p instanceof rn && "=" != p.operator))
                      ));
                m || (m = P(p));
                var x = U(),
                  A = p.may_throw(c),
                ...
                if (!C) {
                  for (
                    var B = c.self().argnames.lastIndexOf(p.name) + 1;
                    !D && B < f.length;
                    B++
                  )
                    f[B].transform(a);
                ...
                for (var S = o; !D && S < t.length; S++) t[S].transform(a);
                if (d) {
                  var T = p.name.definition();
                  if (D && T.references.length - T.replaced > F) F = !1;
                  else {
                    (D = !1), (u = 0), (k = E);
                    for (S = o; !D && S < t.length; S++) t[S].transform(i);
                    d.single_use = !1;
                  }
                }
                F && !I(p) && t.splice(o, 1);
            ...
            if (
              ...
              for (var r = Object.create(null), o = n; 0 <= --o; ) {
                var a = t.argnames[o],
                  s = e.args[o];
                if (
                  (f.unshift(X(Ve, a, { name: a, value: s })), !(a.name in r))
                ) {
                  if (((r[a.name] = !0), s)) {
                    var u = new Sn(function (e) {
                      ...
                      if (e instanceof _n && t.variables.has(e.name)) {
                        ...
                        if (n !== J)
                          for (; (n = n.parent_scope); ) if (n === J) return !0;
                        s = null;
                      }
                      return e instanceof mn && (i || !u.find_parent(Ae))
                        ? !(s = null)
                        : void 0;
                    });
                    s.walk(u);
                  } else s = X(En, a).transform(c);
                  s && l.unshift([X(Ve, a, { name: a, value: s })]);
                }
              }
            }
          }
          function z(e) {
            s.push(e),
              e instanceof rn
                ? (l.push(s.slice()), z(e.right))
                : e instanceof nn
                ? (z(e.left), z(e.right))
                : e instanceof Ye
                ? (z(e.expression), e.args.forEach(z))
                : e instanceof He
                ? z(e.expression)
                : e instanceof tn
                ? (z(e.condition), z(e.consequent), z(e.alternative))
                : e instanceof Ue
                ? e.definitions.forEach(z)
                : e instanceof me
                ? (z(e.condition), e.body instanceof pe || z(e.body))
                : e instanceof Se
                ? e.value && z(e.value)
                : e instanceof ye
                ? (e.init && z(e.init),
                  e.condition && z(e.condition),
                  e.step && z(e.step),
                  e.body instanceof pe || z(e.body))
                : e instanceof we
                ? (z(e.object), e.body instanceof pe || z(e.body))
                : e instanceof Me
                ? (z(e.condition),
                  e.body instanceof pe || z(e.body),
                  !e.alternative ||
                    e.alternative instanceof pe ||
                    z(e.alternative))
                : e instanceof We
                ? e.expressions.forEach(z)
                : e instanceof le
                ? z(e.body)
                : e instanceof qe
                ? (z(e.expression), e.body.forEach(z))
                : e instanceof Ke
                ? "++" == e.operator || "--" == e.operator
                  ? l.push(s.slice())
                  : z(e.expression)
                : e instanceof Ve && e.value && (l.push(s.slice()), z(e.value)),
              s.pop();
          }
          function M(e) {
            if (!(e instanceof Ve))
              return e[e instanceof rn ? "left" : "expression"];
            var n = e.name.definition();
            if (te(e.name, n.orig)) {
              var t = n.orig.length - n.eliminated,
                i = n.references.length - n.replaced;
              return (1 < t && !(e.name instanceof pn)) ||
                (1 < i
                  ? (function (e) {
                      var n = e.value;
          ...
          function R(e) {
            ...
            var i = new Sn(function (e) {
              var n = K(e);
              (n instanceof _n || n instanceof mn) &&
                (t[n.name] = t[n.name] || ne(e, i.parent()));
            });
            return e.walk(i), t;
          }
          function I(i) {
            if (i.name instanceof pn) {
              var e = c.self().argnames.indexOf(i.name),
                n = c.parent().args;
              return n[e] && (n[e] = X(yn, n[e], { value: 0 })), !0;
            }
            var r = !1;
          ...
          function P(e) {
            return (
              !(e instanceof Ke) &&
              ((n = e),
              n[n instanceof rn ? "right" : "value"]).has_side_effects(c)
            );
            var n;
          }
          function U() {
            ...
            if (_ instanceof _n) {
              var e = _.definition();
              if (e.references.length - e.replaced == (p instanceof Ve ? 1 : 2))
                return !0;
            }
            return !1;
          }
          function L(e) {
            var n = e.definition();
            return (
              !(1 == n.orig.length && n.orig[0] instanceof dn) &&
              (n.scope !== J ||
                !oe(n.references, function (e) {
                  var n = e.scope;
        ...
        function i(r, i) {
          for (
            var o = i.self(),
              e = (function (e) {
                for (var n = 0, t = e.length; 0 <= --t; ) {
                  var i = e[t];
                  if (i instanceof Me && i.body instanceof Te && 1 < ++n)
                    return !0;
                }
                return !1;
              })(r),
            ...
            if (a && !u && t instanceof Te) {
              ...
              if (t.value instanceof Qe && "void" == t.value.operator) {
                (W = !0), (r[n] = X(le, t, { body: t.value.expression }));
                continue;
              }
            }
            if (t instanceof Me) {
              var c;
              if (d((c = A(t.body)))) {
                c.label && T(c.label.thedef.references, c),
                  (W = !0),
                  ((t = t.clone()).condition = t.condition.negate(i));
                var f = v(t.body, c);
                (t.body = X(de, t, { body: b(t.alternative).concat(h()) })),
                  (t.alternative = X(de, t, { body: f })),
                  (r[n] = t.transform(i));
                continue;
              }
              if (d((c = A(t.alternative)))) {
                c.label && T(c.label.thedef.references, c),
                  (W = !0),
                  ((t = t.clone()).body = X(de, t.body, {
                    body: b(t.body).concat(h()),
                  }));
                f = v(t.alternative, c);
                (t.alternative = X(de, t.alternative, { body: f })),
                  (r[n] = t.transform(i));
                continue;
              }
            }
            if (t instanceof Me && t.body instanceof Te) {
              ...
              if (
                !l &&
                !t.alternative &&
                ((a && !u) || (u instanceof Te && !u.value))
              ) {
                (W = !0), (r[n] = X(le, t.condition, { body: t.condition }));
                continue;
              }
              if (l && !t.alternative && u instanceof Te && u.value) {
                (W = !0),
                  ((t = t.clone()).alternative = u),
                  r.splice(n, 1, t.transform(i)),
                  r.splice(s, 1);
                continue;
              }
              if (l && !t.alternative && ((!u && a && e) || u instanceof Te)) {
                (W = !0),
                  ((t = t.clone()).alternative =
                    u || X(Te, t, { value: null })),
                  r.splice(n, 1, t.transform(i)),
                  u && r.splice(s, 1);
                continue;
              ...
              if (
                ...
                !t.alternative &&
                p instanceof Me &&
                p.body instanceof Te &&
                _(s) == r.length &&
                u instanceof le
              ) {
                (W = !0),
                  ((t = t.clone()).alternative = X(de, u, {
                    body: [u, X(Te, u, { value: null })],
                  })),
                  r.splice(n, 1, t.transform(i)),
                  r.splice(s, 1);
                continue;
          ...
          function d(e) {
            ...
            return (
              (e instanceof Te &&
                a &&
                (!(n = e.value) ||
                  (n instanceof Qe && "void" == n.operator))) ||
              (e instanceof ze && o === y(t)) ||
              (e instanceof $e && t instanceof de && o === t)
            );
          }
          function h() {
            var e = r.slice(n + 1);
          ...
          function v(e, n) {
            var t = b(e).slice(0, -1);
            return (
              n.value && t.push(X(le, n.value, { body: n.value.expression })), t
            );
          }
          function _(e) {
        ...
        function o(n, t) {
          for (var e, i = t.self(), r = 0, o = 0, a = n.length; r < a; r++) {
            ...
            if (s instanceof Oe) {
              ...
              (s instanceof $e && !(u instanceof _e) && y(u) === i) ||
              (s instanceof ze && y(u) === i)
                ? s.label && T(s.label.thedef.references, s)
                : (n[o++] = s);
            } else n[o++] = s;
            if (A(s)) {
              e = n.slice(r + 1);
          ...
          if (!(n.length < 2)) {
            for (var t = [], i = 0, r = 0, o = n.length; r < o; r++) {
              ...
              if (a instanceof le) {
                ...
                (a instanceof Ue && g(a)) || a instanceof Ce || u(),
                  (n[i++] = a);
            }
            u(), (n.length = i) != o && (W = !0);
          }
        ...
        function p(e, n) {
          ...
          for (var t = null, i = 0, r = e.body.length; i < r; i++) {
            var o = e.body[i];
            if (o instanceof Le && g(o)) n.push(o);
            else {
              if (t) return !1;
              t = o;
            }
        ...
        function s(e, t) {
          ...
          for (var i, r = 0, o = 0; o < e.length; o++) {
            ...
            if (i)
              if (a instanceof Se)
                a.value = n(a.value || X(En, a).transform(t));
                ...
                a instanceof we
                  ? (a.object = n(a.object))
                  : a instanceof Me
                  ? (a.condition = n(a.condition))
                  : a instanceof qe
                  ? (a.expression = n(a.expression))
                  : a instanceof xe && (a.expression = n(a.expression));
        ...
        function f(e, n) {
          if (e instanceof Ue) {
            ...
            if (i.value instanceof an)
              if (
                (n instanceof rn
                  ? (t = [n])
                  : n instanceof We && (t = n.expressions.slice()),
                t)
              ) {
                var r = !1;
                do {
                  ...
                  if ((s instanceof se && (s = s.evaluate(c)), s instanceof se))
                    break;
                  s = "" + s;
                  var u = c.has_directive("use strict")
                    ? function (e) {
                  ...
                  i.value.properties.push(X(un, o, { key: s, value: o.right })),
                    t.shift(),
                    (r = !0);
                } while (t.length);
                return r && t;
            ...
            if (o instanceof Ue)
              a && a.TYPE == o.TYPE
                ? ((a.definitions = a.definitions.concat(o.definitions)),
                  (W = !0))
                : e && e.TYPE == o.TYPE && g(o)
                ? ((e.definitions = e.definitions.concat(o.definitions)),
                  (W = !0))
                : (e = t[++i] = o);
            else if (o instanceof Se) o.value = u(o.value);
            else if (o instanceof ye) {
              (s = f(a, o.init))
                ? ((W = !0),
                  (o.init = s.length ? M(o.init, s) : null),
                  (t[++i] = o))
                : a instanceof Le && (!o.init || o.init.TYPE == a.TYPE)
                ? (o.init &&
                    (a.definitions = a.definitions.concat(o.init.definitions)),
                  (o.init = a),
                  (t[i] = o),
                  (W = !0))
                : e && o.init && e.TYPE == o.init.TYPE && g(o.init)
                ? ((e.definitions = e.definitions.concat(o.init.definitions)),
                  (o.init = null),
                  (t[++i] = o),
                  (W = !0))
                : (t[++i] = o);
            } else if (o instanceof we) o.object = u(o.object);
            else if (o instanceof Me) o.condition = u(o.condition);
      ...
      function w(n, e, t) {
        e instanceof Ce ||
          n.warn("Dropping unreachable code [{file}:{line},{col}]", e.start),
          e.walk(
            new Sn(function (e) {
              return e instanceof Ue
                ? (n.warn(
                  ...
                  e.remove_initializers(),
                  t.push(e),
                  !0)
                : e instanceof Ce
                ? (t.push(e), !0)
                : e instanceof Ae || void 0;
            })
          );
      }
      function p(e) {
        ...
        (function (e) {
          ...
          se.DEFMETHOD("may_throw_on_access", function (e) {
            ...
            e(Xe, function (e) {
              ...
              return (
                n instanceof _n && (n = n.fixed_value()),
                !(n instanceof ke && "prototype" == this.property)
              );
            }),
            e(We, function (e) {
      ...
      var c,
        ...
        f = W("delete ++ --");
      function ne(e, n) {
        return n instanceof Ke && f(n.operator)
          ? n.expression
          : n instanceof rn && n.left === e
          ? e
          : void 0;
      }
      function x(e, n) {
      ...
      function I(e, n, t) {
        return (
          $(e)
            ? function (e, n) {
                return x(X(le, e, { body: e }), X(le, n, { body: n })).body;
              }
            : x
        )(n, t);
      }
      function d(e) {
        for (var n in e) e[n] = W(e[n]);
      }
      (c = function (e, n) {
          ...
          if (e.option("global_defs")) {
            ...
            if (n) {
              for (
                var t, i = this, r = 0;
                (t = i),
                  (i = e.parent(r++)) instanceof Ge && i.expression === t;
            ...
            if (i && ae(i, (t = this.name + n))) {
              var r = (function n(e, t) {
                  ...
                  if (e && "object" == typeof e) {
                    ...
                    for (var r in e)
                      ae(e, r) &&
                        i.push(X(un, t, { key: r, value: n(e[r], t) }));
                    return X(an, t, { properties: i });
                  }
                  return q(e, t);
                })(i[t], this),
                o = e.find_parent(Ee);
              return (
                r.walk(
                  new Sn(function (e) {
                    e instanceof _n &&
                      ((e.scope = o), (e.thedef = o.def_global(e)));
                  })
                ),
                r
              );
      ...
      d(_),
        (function (e) {
          ...
          se.DEFMETHOD("is_constant", function () {
            ...
            e(an, function (e, n, t) {
              if (e.option("unsafe")) {
                for (
                  var i = {}, r = 0, o = this.properties.length;
                  r < o;
                  r++
                ) {
                  var a = this.properties[r],
                    s = a.key;
                  if (s instanceof cn) s = s.name;
                  else if (s instanceof se && (s = s._eval(e, n, t)) === a.key)
                    return this;
                  if ("function" == typeof Object.prototype[s]) return this;
                  if (
                    !(a.value instanceof Fe) &&
                    ((i[s] = a.value._eval(e, n, t)), i[s] === a.value)
                  )
                    return this;
                }
                return i;
          ...
          e(Qe, function (e, n, t) {
            ...
            if (
              ...
              (i instanceof ke ||
                (i instanceof _n && i.fixed_value() instanceof ke))
            )
              return "function";
            if (
              (r(this.operator) || t++,
              (i = i._eval(e, n, t)) === this.expression)
            )
              return this;
          ...
          d(s),
            e(Ge, function (e, n, t) {
              if (e.option("unsafe")) {
                var i = this.property;
                if (i instanceof se && (i = i._eval(e, n, t)) === this.property)
                  return this;
                var r,
                  o = this.expression;
                if (H(o)) {
                  ...
                  if (!(r = o._eval(e, n, t + 1)) || r === o || !ae(r, i))
                    return this;
            ...
            e(Ye, function (n, e, t) {
              ...
              if (n.option("unsafe") && i instanceof Ge) {
                var r,
                  o = i.property;
                if (o instanceof se && (o = o._eval(n, e, t)) === i.property)
                  return this;
                var a = i.expression;
                if (H(a)) {
        ...
        (function (e) {
          function o(e) {
            return X(Qe, e, { operator: "!", expression: e });
          }
          function r(e, n, t) {
            var i = o(e);
            if (t) {
      ...
      Ye.DEFMETHOD("is_expr_pure", function (e) {
        if (e.option("unsafe")) {
          ...
          if (
            n instanceof Xe &&
            H(n.expression) &&
            (_[n.expression.name] || ie)(n.property)
          )
            return !0;
        }
        return this.pure || !e.pure_funcs(this);
      }),
        se.DEFMETHOD("is_call_pure", ie),
        Xe.DEFMETHOD("is_call_pure", function (e) {
          if (e.option("unsafe")) {
            var n = this.expression,
              t = ie;
            return (
              n instanceof on
                ...
                : n.is_string(e)
                ? (t = v.String)
                : this.may_throw_on_access(e) || (t = v.Object),
              t(this.property)
            );
          }
        }),
        ...
        (function (e) {
          ...
          e(se, J),
            ...
            e(rn, function (e) {
              return (
                ...
                (!(
                  ...
                  "=" == this.operator &&
                  this.left instanceof _n
                ) &&
                  this.left.may_throw(e))
              );
            }),
            e(nn, function (e) {
              ...
              return (
                ...
                (!this.is_expr_pure(e) &&
                  (!!this.expression.may_throw(e) ||
                    !(this.expression instanceof ke) ||
                    n(this.expression.body, e)))
              );
            }),
            e(He, function (e) {
            ...
            e(Ke, function (e) {
              return (
                !("typeof" == this.operator && this.expression instanceof _n) &&
                this.expression.may_throw(e)
              );
            }),
            e(Ve, function (e) {
        ...
        (function (e) {
          ...
          e(ue, B),
            ...
            e(Me, function () {
              return (
                this.alternative && A(this.body) && A(this.alternative) && this
              );
            });
        })(function (e, n) {
        ...
        e(ve, function (e, n) {
          return e.body instanceof $e && n.loopcontrol_target(e.body) === e.body
            ? X(he, e)
            : 0 == e.label.references.length
            ? e.body
            : e;
        }),
        e(pe, function (e, n) {
        ...
        e(ke, function (e, n) {
          return (
            ...
            n.option("side_effects") &&
              1 == e.body.length &&
              e.body[0] === n.has_directive("use strict") &&
              (e.body.length = 0),
            e
          );
        }),
        Ae.DEFMETHOD("drop_unused", function (b) {
          if (b.option("unused") && !b.has_directive("use asm")) {
            ...
            if (!y.uses_eval && !y.uses_with) {
              var w = !(y instanceof Ee) || b.toplevel.funcs,
                ...
                A = /keep_assign/.test(b.option("unused"))
                  ? ie
                  : function (e, n) {
                      var t;
                      if (
                        (e instanceof rn && (e.write_only || "=" == e.operator)
                          ? (t = e.left)
                          : e instanceof Ke &&
                            e.write_only &&
                            (t = e.expression),
                        /strict/.test(b.option("pure_getters")))
                      )
                        for (
                          ;
                          t instanceof Ge &&
                          !t.expression.may_throw_on_access(b);

                        )
                          t instanceof Ze && n.unshift(t.property),
                            (t = t.expression);
                      return t;
                    },
                s = [],
              ...
              var D = new O(),
                ...
                f = new Sn(function (e, n) {
                  if (e !== y) {
                    ...
                    return (
                      e instanceof pn && F === y && D.add(e.definition().id, e),
                      e instanceof Ue && F === y
                        ? (e.definitions.forEach(function (e) {
                            var n = e.name.definition();
                            e.name instanceof ln && D.add(n.id, e),
                              x || n.id in E || ((E[n.id] = !0), s.push(n)),
                              e.value &&
                                (i.add(n.id, e.value),
                                e.value.has_side_effects(b) && e.value.walk(f),
                                n.chained ||
                                  e.name.fixed_value() !== e.value ||
                                  (k[n.id] = e));
                          }),
                          !0)
                        : r(e, n)
              ...
              var C = new Xn(function (a, e, n) {
                ...
                if (F === y) {
                  var s;
                  if (a instanceof Fe && a.name && !b.option("keep_fnames"))
                    ((s = a.name.definition()).id in E &&
                      !(1 < s.orig.length)) ||
                      (a.name = null);
                  if (a instanceof ke && !(a instanceof De))
                    for (
                      var u = !b.option("keep_fargs"),
                        c = a.argnames,
                        f = c.length;
                      0 <= --f;
                      ...
                      var l;
                      (l = c[f]).definition().id in E
                        ? (u = !1)
                        : ((l.__unused = !0),
                          u &&
                            (c.pop(),
                            b[l.unreferenced() ? "warn" : "info"](
                              "Dropping unused function argument {name} [{file}:{line},{col}]",
                              g(l)
                            )));
                    }
                  if (w && a instanceof Ce && a !== y)
                    if (!((s = a.name.definition()).id in E))
                      return (
                        b[a.name.unreferenced() ? "warn" : "info"](
                  ...
                  if (a instanceof Ue && !(t instanceof we && t.init === a)) {
                    ...
                    switch (
                        ...
                        if (!x || n.id in E) {
                          if (
                            (e.value &&
                              n.id in k &&
                              k[n.id] !== e &&
                              (e.value = e.value.drop_side_effect_free(b)),
                            e.name instanceof ln)
                          ) {
                            var t = D.get(n.id);
                            if (
                              1 < t.length &&
                              (!e.value ||
                                n.orig.indexOf(e.name) > n.eliminated)
                            ) {
                              if (
                                (b.warn(
                          ...
                          e.value
                            ? (0 < v.length &&
                                (0 < h.length
                                  ? (v.push(e.value), (e.value = M(e.value, v)))
                                  : p.push(X(le, a, { body: M(a, v) })),
                                (v = [])),
                              h.push(e))
                            : d.push(e);
                        } else if (n.orig[0] instanceof vn) {
                          (o = e.value && e.value.drop_side_effect_free(b)) &&
                            v.push(o),
                            (e.value = null),
                            d.push(e);
                        } else {
                          ...
                          (o = e.value && e.value.drop_side_effect_free(b))
                            ? (b.warn(
                              ...
                              v.push(o))
                            : b[e.name.unreferenced() ? "warn" : "info"](
                      ...
                      (0 < d.length || 0 < h.length) &&
                        ((a.definitions = d.concat(h)), p.push(a)),
                      0 < v.length && p.push(X(le, a, { body: M(a, v) })),
                      p.length)
                    ) {
                      case 0:
                      ...
                      case 1:
                        return p[0];
                      default:
                        return n ? re.splice(p) : X(de, a, { body: p });
                    }
                  }
                  if (a instanceof ye)
                    return (
                      e(a, this),
                      a.init instanceof de &&
                        ((_ = a.init), (a.init = _.body.pop()), _.body.push(a)),
                      a.init instanceof le
                        ? (a.init = a.init.body)
                        : j(a.init) && (a.init = null),
                      _ ? (n ? re.splice(_.body) : _) : a
                    );
          ...
          function r(e, n) {
            ...
            if (
              r instanceof _n &&
              y.variables.get(r.name) === (t = r.definition())
            ) {
              if (
                (i.forEach(function (e) {
                  e.walk(f);
                ...
                if ((e.right.walk(f), e.left === r))
                  t.chained || r.fixed_value() !== e.right || (k[t.id] = e),
                    e.write_only || l(t, !0, c[t.id]);
                else {
                  var o = r.fixed_value();
            ...
            if (e instanceof _n)
              return (
                (t = e.definition()).id in E || ((E[t.id] = !0), s.push(t)), !0
              );
            if (e instanceof Ae) {
              var a = F;
              return (F = e), n(), (F = a), !0;
            ...
            var p = new Xn(function (e) {
              if (e !== o) {
                ...
                if (
                  a &&
                  e instanceof Ce &&
                  (p.parent() === o || !r.has_directive("use strict"))
                )
                  return c.push(e), X(he, e);
                if (s && e instanceof Le) {
                  ...
                  return t instanceof ye && t.init === e
                    ? n
                    : n
                    ? X(le, e, { body: n })
                    : X(he, e);
              ...
              if (
                (f.each(function (n, e) {
                  ...
                  V(function (e) {
                    ...
                    ? f.del(e)
                    : (((n = n.clone()).value = null), t.push(n), f.set(e, n));
                }),
                0 < t.length)
              ) {
                for (var e = 0; e < o.body.length; ) {
                  if (o.body[e] instanceof le) {
                    ...
                    if (
                      h instanceof We &&
                      (d = h.expressions[0]) instanceof rn &&
                      "=" == d.operator &&
                      (i = d.left) instanceof cn &&
                      f.has(i.name)
                    ) {
                      var v;
                      if ((v = f.get(i.name)).value) break;
                      (v.value = d.right),
                        T(t, v),
                        t.push(v),
                        (o.body[e].body = M(h, h.expressions.slice(1)));
                      continue;
                    }
                  }
                  if (o.body[e] instanceof he) o.body.splice(e, 1);
                  else {
                ...
                (t = X(Le, o, { definitions: t })), c.push(t);
              }
            }
        ...
        Ae.DEFMETHOD("var_names", function () {
          ...
          return (
            t ||
              ((this._var_names = t = Object.create(null)),
        ...
        Ae.DEFMETHOD("make_var_name", function (e) {
          for (
            var n = this.var_names(),
              t = (e = e.replace(/(?:^[^a-z_$]|[^a-z0-9_$])/gi, "_")),
              i = 0;
            n[t];
            i++
          )
          ...
          return u.transform(
            new Xn(function (r, e) {
              ...
              if (
                r instanceof Ve &&
                (s = r.name).scope === u &&
                1 != (t = s.definition()).escaped &&
                !t.single_use &&
                !t.direct_access &&
                !i(t) &&
                (n = s.fixed_value()) === r.value &&
                n instanceof an
              ) {
                e(r, this);
                var o = new O(),
              ...
              if (
                r instanceof Ge &&
                r.expression instanceof _n &&
                (o = c[r.expression.definition().id])
              ) {
                var s,
        ...
        (function (e) {
          ...
          e(se, C),
            ...
            e(Ye, function (n, e) {
              if (!this.is_expr_pure(n)) {
                if (this.expression.is_call_pure(n)) {
                  ...
                  return (
                    t.unshift(this.expression.expression),
                    (t = a(t, n, e)) && M(this, t)
                  );
                }
                if (
                  ...
                  var i = this.clone(),
                    r = i.expression;
                  return (
                    r.process_expression(!1, n),
                    r.walk(
                      new Sn(function (e) {
                        return e instanceof Te && e.value
                          ? ((e.value = e.value.drop_side_effect_free(n)), !0)
                          : (e instanceof Ae && e !== r) || void 0;
                      })
                    ),
                    i
                  );
            ...
            e(nn, function (e, n) {
              ...
              return r
                ? M(this, [r, t])
                : this.right.drop_side_effect_free(e, n);
            }),
            e(rn, function (e) {
              var n = this.left;
              return n.has_side_effects(e) ||
                ...
                ? this
                : ((this.write_only = !0),
                  K(n).is_constant_expression(e.find_parent(Ae))
                    ? this.right.drop_side_effect_free(e)
                    : this);
            }),
            e(tn, function (e) {
            ...
            e(Ke, function (e, n) {
              if (f(this.operator))
                return (
                  (this.write_only = !this.expression.has_side_effects(e)), this
                );
            ...
            e(Xe, function (e, n) {
              return this.expression.may_throw_on_access(e)
                ? this
                : this.expression.drop_side_effect_free(e, n);
            }),
            e(Ze, function (e, n) {
        ...
        e(ge, function (n, e) {
          ...
          var t =
            n.condition.is_truthy() || n.condition.tail_node().evaluate(e);
          if (!(t instanceof se)) {
            if (t)
              return X(ye, n, {
                body: X(de, n.body, {
                  body: [n.body, X(le, n.condition, { body: n.condition })],
                }),
              }).optimize(e);
            var i = !1,
              r = new Sn(function (e) {
                return (
                  !!(e instanceof Ae || i) ||
                  (e instanceof Oe && r.loopcontrol_target(e) === n
                    ? (i = !0)
                    : void 0)
                );
              }),
              o = e.parent();
            if (((o instanceof ve ? o : n).walk(r), !i))
              return X(de, n.body, {
                body: [n.body, X(le, n.condition, { body: n.condition })],
              }).optimize(e);
          }
          return n.body instanceof le
            ? X(ye, n, {
        ...
        e(ye, function (e, n) {
          ...
          if (
            ...
            if (!(t instanceof se))
              if (t) e.condition = null;
                ...
                var i = e.condition;
                (e.condition = q(t, e.condition)),
                  (e.condition = x(e.condition.transform(n), i));
              }
            if (
              (t instanceof se &&
                (t =
                  e.condition.is_truthy() ||
                  e.condition.tail_node().evaluate(n)),
              t)
            )
              !e.condition ||
                t instanceof se ||
                ((e.body = X(de, e.body, {
                  body: [X(le, e.condition, { body: e.condition }), e.body],
                })),
                (e.condition = null));
            else if (n.option("dead_code")) {
              var r = [];
              return (
                w(n, e.body, r),
                e.init instanceof ue
                  ? r.push(e.init)
                  : e.init && r.push(X(le, e.init, { body: e.init })),
                r.push(X(le, e.condition, { body: e.condition })),
                X(de, e, { body: r }).optimize(n)
              );
            }
          }
          return (function n(t, i) {
            ...
            if (i.option("dead_code") && o(e)) {
              var r = [];
              return (
                t.init instanceof ue
                  ? r.push(t.init)
                  : t.init && r.push(X(le, t.init, { body: t.init })),
                t.condition &&
                  r.push(X(le, t.condition, { body: t.condition })),
                w(i, t.body, r),
                X(de, t, { body: r })
              );
            }
            return (
              e instanceof Me &&
                (o(e.body)
                  ? (t.condition
                      ? (t.condition = X(nn, t.condition, {
                          left: t.condition,
                          operator: "&&",
                          right: e.condition.negate(i),
                        }))
                      : (t.condition = e.condition.negate(i)),
                    a(e.alternative))
                  : o(e.alternative) &&
                    (t.condition
                      ? (t.condition = X(nn, t.condition, {
            ...
            function a(e) {
              (e = b(e)),
                t.body instanceof de
                  ? ((t.body = t.body.clone()),
                    (t.body.body = e.concat(t.body.body.slice(1))),
                    (t.body = t.body.transform(i)))
                  : (t.body = X(de, t.body, { body: e }).transform(i)),
                (t = n(t, i));
            }
          })(e, n);
        }),
        e(Me, function (e, n) {
          if (
            (j(e.alternative) && (e.alternative = null),
            !n.option("conditionals"))
          )
            return e;
          var t = e.condition.evaluate(n);
          ...
          if (n.option("dead_code")) {
            if (
              ...
              return (
                w(n, e.body, r),
                r.push(X(le, e.condition, { body: e.condition })),
                e.alternative && r.push(e.alternative),
                X(de, e, { body: r }).optimize(n)
              );
            }
            if (!(t instanceof se)) {
              ...
              r = [];
              return (
                e.alternative && w(n, e.alternative, r),
                r.push(X(le, e.condition, { body: e.condition })),
                r.push(e.body),
                X(de, e, { body: r }).optimize(n)
              );
          ...
          if (j(e.body) && j(e.alternative))
            return X(le, e.condition, { body: e.condition.clone() }).optimize(
              n
            );
          if (e.body instanceof le && e.alternative instanceof le)
            return X(le, e, {
              body: X(tn, e, {
          ...
          if (j(e.alternative) && e.body instanceof le)
            return (
              a === s &&
                !u &&
                e.condition instanceof nn &&
          ...
          if (e.body instanceof he && e.alternative instanceof le)
            return X(le, e, {
              body: X(nn, e, {
                operator: "||",
                left: e.condition,
          ...
          if (
            e.body instanceof Se &&
            e.alternative instanceof Se &&
            e.body.TYPE == e.alternative.TYPE
          )
            return X(e.body.CTOR, e, {
              value: X(tn, e, {
                condition: e.condition,
          ...
          if (
            ...
            var f = e.alternative;
            return (
              (e.alternative = null), X(de, e, { body: [e, f] }).optimize(n)
            );
          }
          if (A(e.alternative)) {
            r = e.body;
        ...
        e(qe, function (n, t) {
          ...
          if (!(i instanceof se)) {
            var r = n.expression;
            (n.expression = q(i, r)),
              (n.expression = x(n.expression.transform(t), r));
          }
          if (!t.option("dead_code")) return n;
          i instanceof se && (i = n.expression.tail_node().evaluate(t));
          for (
            var o, a, s = [], u = [], c = 0, f = n.body.length;
            c < f && !a;
            c++
          ) {
            if ((e = n.body[c]) instanceof Ne)
              o ? g(e, u[u.length - 1]) : (o = e);
              ...
              if (
                (_ instanceof se && (_ = e.expression.tail_node().evaluate(t)),
                _ === i && ((a = e), o))
              ) {
                var l = u.indexOf(o);
            ...
            if (A(e)) {
              var p = u[u.length - 1];
              A(p) &&
                p.body.length == e.body.length &&
                X(de, p, p).equivalent_to(X(de, e, e)) &&
                (p.body = []);
            }
            u.push(e);
          }
          for (; c < f; ) g(n.body[c++], u[u.length - 1]);
          for (
            0 < u.length && (u[0].body = s.concat(u[0].body)), n.body = u;
            (e = u[u.length - 1]);

          ) {
            var d = e.body[e.body.length - 1];
            if (
              (d instanceof $e && t.loopcontrol_target(d) === n && e.body.pop(),
              e.body.length ||
                (e instanceof He && (o || e.expression.has_side_effects(t))))
            )
              break;
            u.pop() === o && (o = null);
          }
          if (0 == u.length)
            return X(de, n, {
              body: s.concat(X(le, n.expression, { body: n.expression })),
            }).optimize(t);
          if (1 == u.length && (u[0] === a || u[0] === o)) {
            ...
            if ((n.walk(v), !h)) {
              var _,
                m = u[0].body.slice();
              return (
                (_ = u[0].expression) && m.unshift(X(le, _, { body: _ })),
                m.unshift(X(le, n.expression, { body: n.expression })),
                X(de, n, { body: m }).optimize(t)
              );
            }
          }
          return n;
        ...
        e(Re, function (e, n) {
          if (
            ...
            e.bcatch &&
              e.bfinally &&
              oe(e.bfinally.body, j) &&
              (e.bfinally = null),
            n.option("dead_code") && oe(e.body, j))
          ) {
            var t = [];
            return (
              e.bcatch &&
              ...
              e.bfinally && (t = t.concat(e.bfinally.body)),
              X(de, e, { body: t }).optimize(n)
            );
          }
          return e;
        }),
          ...
          var i = e.option("reduce_vars"),
            n = this.definitions.reduce(function (e, n) {
              if (n.value) {
                ...
                e.push(X(rn, n, { operator: "=", left: t, right: n.value })),
        ...
        e(Ye, function (s, r) {
          ...
          if (r.option("unused") && n && !p.uses_arguments && !p.uses_eval) {
            for (var t = 0, i = 0, o = 0, a = s.args.length; o < a; o++) {
              ...
              if (u || p.argnames[o].__unused) {
                if ((d = s.args[o].drop_side_effect_free(r))) s.args[t++] = d;
                else if (!u) {
                  s.args[t++] = X(yn, s.args[o], { value: 0 });
                  continue;
                }
          ...
          if (r.option("unsafe"))
            if (H(e))
              switch (e.name) {
                case "Array":
                  if (1 != s.args.length)
                    return X(on, s, { elements: s.args }).optimize(r);
                  break;
                case "Object":
                  if (0 == s.args.length) return X(an, s, { properties: [] });
                  break;
                case "String":
                  if (0 == s.args.length) return X(bn, s, { value: "" });
                  if (s.args.length <= 1)
                    return X(nn, s, {
                      left: s.args[0],
                      operator: "+",
                  ...
                  break;
                case "Number":
                  if (0 == s.args.length) return X(yn, s, { value: 0 });
                  if (1 == s.args.length)
                    return X(Qe, s, {
                      expression: s.args[0],
                      operator: "+",
                  ...
                  if (
                    ...
                    try {
                      return I(
                        r,
                        s,
                        X(wn, s, { value: RegExp.apply(RegExp, c) })
                      );
                    } catch (e) {
              ...
              switch (e.property) {
                case "toString":
                  if (
                    0 == s.args.length &&
                    !e.expression.may_throw_on_access(r)
                  )
                    return X(nn, s, {
                      left: X(bn, s, { value: "" }),
                      operator: "+",
                ...
                case "join":
                  var f;
                  if (e.expression instanceof on)
                    if (
                      !(
                        0 < s.args.length &&
                        (f = s.args[0].evaluate(r)) === s.args[0]
                      )
                    ) {
                      var l,
                        d,
                        ...
                        v = [];
                      return (
                        e.expression.elements.forEach(function (e) {
                          var n = e.evaluate(r);
                          n !== e
                            ? v.push(n)
                            : (0 < v.length &&
                                (h.push(X(bn, s, { value: v.join(f) })),
                                (v.length = 0)),
                              h.push(e));
                        }),
                        0 < v.length && h.push(X(bn, s, { value: v.join(f) })),
                        0 == h.length
                          ? X(bn, s, { value: "" })
                          : 1 == h.length
                          ? h[0].is_string(r)
                          ...
                          : "" == f
                          ? ((l =
                              h[0].is_string(r) || h[1].is_string(r)
                                ? h.shift()
                                : X(bn, s, { value: "" })),
                            h
                              .reduce(function (e, n) {
                              ...
                              .optimize(r))
                          : (((d = s.clone()).expression =
                              d.expression.clone()),
                            (d.expression.expression =
                              d.expression.expression.clone()),
                            (d.expression.expression.elements = h),
                            I(r, s, d))
                      );
                    }
                  break;
                case "charAt":
                  ...
                  break;
                case "apply":
                  if (2 == s.args.length && s.args[1] instanceof on)
                    return (
                      (k = s.args[1].elements.slice()).unshift(s.args[0]),
                      X(Ye, s, {
                        expression: X(Xe, e, {
                          expression: e.expression,
                          property: "call",
                ...
                case "call":
                  var g = e.expression;
                  if (
                    (g instanceof _n && (g = g.fixed_value()),
                    g instanceof ke && !g.contains_this())
                  )
                    return M(this, [
                      s.args[0],
                      X(Ye, s, {
          ...
          if (r.option("unsafe_Function") && H(e) && "Function" == e.name) {
            if (0 == s.args.length) return X(Fe, s, { argnames: [], body: [] });
            if (
              oe(s.args, function (e) {
              ...
              try {
                ...
                var w,
                  x = new et(r.options);
                (b = b.transform(x)).figure_out_scope(y),
                  b.compute_char_frequency(y),
                  b.mangle_names(y),
                  b.walk(
                    new Sn(function (e) {
                ...
                var A = Qn();
                return (
                  de.prototype._codegen.call(w, w, A),
                  (s.args = [
                    X(bn, s, {
                      value: w.argnames
                        .map(function (e) {
          ...
          if (
            r.option("inline") &&
            E instanceof Te &&
            (!(F = E.value) || F.is_constant_expression())
          ) {
          ...
          if (n) {
            ...
            if (
              ...
              (e === p ||
                (r.option("unused") &&
                  1 == (D = e.definition()).references.length &&
                  !P(r, D) &&
                  p.is_constant_expression(e.scope))) &&
              !s.pure &&
              !p.contains_this() &&
              (function () {
                var e = Object.create(null);
                do {
                  if ((C = r.parent(++S)) instanceof Ie) e[C.argname.name] = !0;
                  else if (C instanceof _e) B = [];
                  else if (C instanceof _n && C.fixed_value() instanceof Ae)
                    return !1;
                    ...
                    for (var t = p.body.length, i = 0; i < t; i++) {
                      ...
                      if (r instanceof Le) {
                        ...
                        for (var o = r.definitions.length; 0 <= --o; ) {
                          ...
                          if (e[a.name] || R(a.name) || C.var_names()[a.name])
                            return !1;
              ...
              return (
                ...
                M(
                  ...
                  (function () {
                    ...
                    (function (e, n) {
                      for (
                        var t = p.argnames.length, i = s.args.length;
                        --i >= t;
                      ...
                      for (i = t; 0 <= --i; ) {
                        var r = p.argnames[i],
                          o = s.args[i];
                        if (r.__unused || C.var_names()[r.name]) o && n.push(o);
                        else {
                          var a = X(ln, r, r);
                          r.definition().orig.push(a),
                            !o && B && (o = X(En, s)),
                            z(e, n, a, o);
                        }
                      }
                      ...
                      (function (e, n) {
                        for (
                          var t = n.length, i = 0, r = p.body.length;
                          i < r;
                          i++
                        ) {
                          var o = p.body[i];
                          if (o instanceof Le)
                            for (
                              var a = 0, s = o.definitions.length;
                              a < s;
                              a++
                            ) {
                      ...
                      n.push(F),
                      e.length &&
                        ((o = C.body.indexOf(r.parent(S - 1)) + 1),
                        C.body.splice(o, 0, X(Le, p, { definitions: e })));
                    return n;
                  })()
                ).optimize(r)
              );
          ...
          if (r.option("drop_console") && e instanceof Ge) {
            for (var T = e.expression; T.expression; ) T = T.expression;
            if (H(T) && "console" == T.name) return X(En, s).optimize(r);
          }
          if (r.option("negate_iife") && r.parent() instanceof le && N(s))
            return s.negate(r, !0);
          var O = s.evaluate(r);
            ...
            return e
              ? e instanceof Te
                ? e.value
                  ...
                  : X(En, s)
                : e instanceof le
                ? X(Qe, e, { operator: "void", expression: e.body.clone(!0) })
                : void 0
              : X(En, s);
          }
          function z(e, n, t, i) {
            var r = t.definition();
            C.variables.set(t.name, r),
              C.enclosed.push(r),
              C.var_names()[t.name] ||
                ((C.var_names()[t.name] = !0),
                e.push(X(Ve, t, { name: t, value: null })));
            var o = X(_n, t, t);
            r.references.push(o),
              i && n.push(X(rn, s, { operator: "=", left: o, right: i }));
          }
        }),
        e(Je, function (e, n) {
          if (n.option("unsafe")) {
        ...
        e(We, function (e, t) {
          ...
          (i = $(t)),
            ...
            e.expressions.forEach(function (e, n) {
              n < r && (e = e.drop_side_effect_free(t, i)),
                e && (l(o, e), (i = !1));
            });
          var n = o.length - 1;
          return (
            (function () {
              for (; 0 < n && g(o[n], t); ) n--;
              n < o.length - 1 &&
                ((o[n] = X(Qe, e, { operator: "void", expression: o[n] })),
                (o.length = n + 1));
            })(),
            0 == n
              ? (e = Z(t.parent(), t.self(), o[0])) instanceof We ||
                (e = e.optimize(t))
              : (e.expressions = o),
            e
          );
        ...
        e(Qe, function (e, n) {
          ...
          if (
            "delete" == e.operator &&
            !(t instanceof _n || t instanceof Ge || Q(t))
          )
            return t instanceof We
              ? ((t = t.expressions.slice()).push(X(Bn, e)),
                M(e, t).optimize(n))
              : M(e, [t, X(Bn, e)]).optimize(n);
          var i = e.lift_sequences(n);
          if (i !== e) return i;
          if (n.option("side_effects") && "void" == e.operator)
            return (t = t.drop_side_effect_free(n))
              ? ((e.expression = t), e)
              : X(En, e).optimize(n);
          if (n.option("booleans")) {
            if ("!" == e.operator && t.is_truthy())
              return M(e, [t, X(Cn, e)]).optimize(n);
            if (n.in_boolean_context())
              switch (e.operator) {
                case "!":
                ...
                case "typeof":
                  return (
                    ...
                    (t instanceof _n ? X(Bn, e) : M(e, [t, X(Bn, e)])).optimize(
                      n
                    )
                  );
              }
          ...
          if (
            ("-" == e.operator && t instanceof Dn && (t = t.transform(n)),
            t instanceof nn &&
              ("+" == e.operator || "-" == e.operator) &&
            ...
            return X(nn, e, {
              operator: t.operator,
              left: X(Qe, t.left, { operator: e.operator, expression: t.left }),
              right: t.right,
            });
        ...
        nn.DEFMETHOD("lift_sequences", function (e) {
          if (e.option("sequences")) {
            ...
            if (this.right instanceof We && !this.left.has_side_effects(e)) {
              for (
                var t,
                  i = "=" == this.operator && this.left instanceof _n,
                  r = (n = this.right.expressions).length - 1,
                  o = 0;
                o < r && (i || !n[o].has_side_effects(e));
                o++
              );
              if (o == r)
                return (
                  (n = n.slice()),
                  ((t = this.clone()).right = n.pop()),
                  n.push(t),
                  M(this, n).optimize(e)
                );
              if (0 < o)
                return (
                  ((t = this.clone()).right = M(this.right, n.slice(o))),
                  (n = n.slice(0, o)).push(t),
                  M(this, n).optimize(e)
                );
            }
          }
      ...
      function U(t, n) {
        var i = !1,
          r = new Sn(function (e) {
            return (
              !!i ||
              (e instanceof _n && te(e.definition(), n) ? (i = !0) : void 0)
            );
          }),
          o = new Sn(function (e) {
            if (i) return !0;
      ...
      e(nn, function (t, n) {
        function i() {
          return (
            t.left.is_constant() ||
            t.right.is_constant() ||
            (!t.left.has_side_effects(n) && !t.right.has_side_effects(n))
          );
        }
        function e(e) {
          if (i()) {
        ...
        if (
          (E(t.operator) &&
            t.right.is_constant() &&
            !t.left.is_constant() &&
            ((t.left instanceof nn && Jn[t.left.operator] >= Jn[t.operator]) ||
              e()),
          (t = t.lift_sequences(n)),
          n.option("comparisons"))
        )
          switch (t.operator) {
            case "===":
            case "!==":
              var r = !0;
              ((t.left.is_string(n) && t.right.is_string(n)) ||
                (t.left.is_number(n) && t.right.is_number(n)) ||
                (t.left.is_boolean() && t.right.is_boolean()) ||
                t.left.equivalent_to(t.right)) &&
                (t.operator = t.operator.substr(0, 2));
            case "==":
            case "!=":
              if (!r && g(t.left, n)) t.left = X(xn, t.left);
              else if (
                n.option("typeofs") &&
                t.left instanceof bn &&
                "undefined" == t.left.value &&
                t.right instanceof Qe &&
                "typeof" == t.right.operator
              ) {
                var o = t.right.expression;
                (o instanceof _n
                  ? !o.is_declared(n)
                  : o instanceof Ge && n.option("ie8")) ||
                  ((t.right = o),
                  (t.left = X(En, t.left).optimize(n)),
                  2 == t.operator.length && (t.operator += "="));
              } else if (
                t.left instanceof _n &&
                t.right instanceof _n &&
                t.left.definition() === t.right.definition() &&
                ((u = t.left.fixed_value()) instanceof on ||
                  u instanceof ke ||
                  u instanceof an)
              )
                return X("=" == t.operator[0] ? Bn : Cn, t);
              break;
            case "&&":
            case "||":
              var a = t.left;
              if (
                (a.operator == t.operator && (a = a.right),
                a instanceof nn &&
                  a.operator == ("&&" == t.operator ? "!==" : "===") &&
                  t.right instanceof nn &&
                  a.operator == t.right.operator &&
                  ((g(a.left, n) && t.right.left instanceof xn) ||
                    (a.left instanceof xn && g(t.right.left, n))) &&
                  !a.right.has_side_effects(n) &&
                  a.right.equivalent_to(t.right.right))
              ) {
                var s = X(nn, t, {
        ...
        if ("+" == t.operator) {
          ...
          if (
            ...
            return t.right;
          if (
            t.left instanceof nn &&
            "+" == t.left.operator &&
            t.left.left instanceof bn &&
            "" == t.left.left.getValue() &&
            t.right.is_string(n)
          )
            return (t.left = t.left.right), t.transform(n);
        }
        if (n.option("evaluate")) {
          switch (t.operator) {
            case "&&":
              if (!(c = m(t.left)))
                return (
                  ...
                  Z(n.parent(), n.self(), t.left).optimize(n)
                );
              if (!(c instanceof se))
                return (
                  n.warn(
              ...
              if ((f = t.right.evaluate(n))) {
                if (!(f instanceof se)) {
                  if (
                    ("&&" == (p = n.parent()).operator &&
                      p.left === n.self()) ||
                    (n.option("booleans") && n.in_boolean_context())
                  )
                    return (
                      n.warn(
                ...
                if (n.option("booleans") && n.in_boolean_context())
                  return (
                    ...
                    M(t, [t.left, X(Cn, t)]).optimize(n)
                  );
                t.falsy = !0;
              }
              if ("||" == t.left.operator)
                if (!(d = t.left.right.evaluate(n)))
                  return X(tn, t, {
            ...
            case "||":
              ...
              if ((f = t.right.evaluate(n))) {
                ...
                ("||" == (p = n.parent()).operator && p.left === n.self()) ||
                (n.option("booleans") && n.in_boolean_context())
              )
                return (
                  n.warn(
              ...
              if ("&&" == t.left.operator)
                if ((d = t.left.right.evaluate(n)) && !(d instanceof se))
                  return X(tn, t, {
                    condition: t.left.left,
          ...
          switch (t.operator) {
            case "+":
              if (
                (t.left instanceof gn &&
                  t.right instanceof nn &&
                  "+" == t.right.operator &&
                  t.right.left instanceof gn &&
                  t.right.is_string(n) &&
                  (t = X(nn, t, {
                    operator: "+",
                    left: X(bn, t.left, {
                ...
                t.right instanceof gn &&
                  t.left instanceof nn &&
                  "+" == t.left.operator &&
                  t.left.right instanceof gn &&
                  t.left.is_string(n) &&
                  (t = X(nn, t, {
                    operator: "+",
                    left: t.left.left,
                  ...
                  (t = X(nn, t, {
                    ...
                    left: X(nn, t.left, {
                      ...
                      right: X(bn, t.left.right, {
                        value:
                          "" +
                          t.left.right.getValue() +
                          t.right.left.getValue(),
                        start: t.left.right.start,
                        end: t.right.left.end,
                      }),
                    }),
            ...
            case "^":
              if (
                ...
                !(
                  t.left instanceof nn &&
                  t.left.operator != t.operator &&
                  Jn[t.left.operator] >= Jn[t.operator]
                )
              ) {
                var v = X(nn, t, {
                  operator: t.operator,
                ...
                t =
                  t.right instanceof gn && !(t.left instanceof gn)
                    ? I(n, v, t)
                    : I(n, t, v);
              }
              h &&
        ...
        if (
          ...
          (ee(t.operator) ||
            ("+" == t.operator &&
              (t.right.left.is_string(n) ||
                (t.left.is_string(n) && t.right.right.is_string(n)))))
        )
          return (
            (t.left = X(nn, t.left, {
              operator: t.operator,
        ...
        e(_n, function (e, n) {
          ...
          if (
            !n.option("ie8") &&
            H(e) &&
            (!e.scope.uses_with || !n.find_parent(xe))
          )
            switch (e.name) {
              case "undefined":
          ...
          if (n.option("reduce_vars") && ne(e, n.parent()) !== e) {
            var r = e.definition(),
              o = e.fixed_value(),
              a = r.single_use;
            if (a && o instanceof ke)
              if (
                r.scope === e.scope ||
                (n.option("reduce_funcs") && 1 != r.escaped && !o.inlined)
              ) {
                if (P(n, r)) a = !1;
                else if (
                  (r.scope !== e.scope || r.orig[0] instanceof pn) &&
                  "f" == (a = o.is_constant_expression(e.scope))
                )
                  for (
                    var s = e.scope;
                    (s instanceof Ce || s instanceof Fe) && (s.inlined = !0),
                      (s = s.parent_scope);
            ...
            if (a && o) {
              var u;
              if (
                (o instanceof Ce && ((o._squeezed = !0), (o = X(Fe, o, o))),
                0 < r.recursive_refs && o.name instanceof dn)
              ) {
                var c = (u = o.clone(!0)).name.definition(),
                  f = u.variables.get(u.name.name),
                  l = f && f.orig[0];
                l instanceof hn ||
                  ((((l = X(hn, u.name, u.name)).scope = u).name = l),
                  (f = u.def_function(l))),
                  u.walk(
                    new Sn(function (e) {
                      e instanceof _n &&
                        e.definition() === c &&
                        (e.thedef = f).references.push(e);
                    })
                  );
            ...
            if (o && void 0 === r.should_replace) {
              var p;
              if (o instanceof mn)
                r.orig[0] instanceof pn ||
                  !oe(r.references, function (e) {
                ...
                var d = o.evaluate(n);
                d === o ||
                  (!n.option("unsafe_regexp") && d instanceof RegExp) ||
                  (p = q(d, o));
              }
              if (p) {
                var h,
                ...
                n.option("unused") &&
                  !n.exposed(r) &&
                  (m = (_ + 2 + v) / (r.references.length - r.assignments)),
                  (r.should_replace = v <= _ + m && h);
        ...
        e(Dn, function (e, n) {
          ...
          return t && k(t, e)
            ? e
            : !n.option("keep_infinity") || (t && !k(t, e)) || o(n, "Infinity")
            ? X(nn, e, {
                operator: "/",
                left: X(yn, e, { value: 1 }),
                right: X(yn, e, { value: 0 }),
              })
            : e;
        }),
        e(An, function (e, n) {
          var t = ne(n.self(), n.parent());
          return (t && !k(t, e)) || o(n, "NaN")
            ? X(nn, e, {
                operator: "/",
                left: X(yn, e, { value: 0 }),
                right: X(yn, e, { value: 0 }),
      ...
      e(rn, function (a, s) {
        ...
        if (
          s.option("dead_code") &&
          a.left instanceof _n &&
          (e = a.left.definition()).scope === s.find_parent(ke)
        ) {
          var n,
            t = 0,
            i = a;
          do {
            ...
            (i instanceof nn && i.right === n) ||
            (i instanceof We && i.tail_node() === n)
          );
        }
        return (
          "=" == (a = a.lift_sequences(s)).operator &&
            a.left instanceof _n &&
            a.right instanceof nn &&
            (a.right.left instanceof _n &&
            a.right.left.name == a.left.name &&
            te(a.right.operator, D)
              ? ((a.operator = a.right.operator + "="),
                (a.right = a.right.right))
              : a.right.right instanceof _n &&
                a.right.right.name == a.left.name &&
                te(a.right.operator, F) &&
                !a.right.left.has_side_effects(s) &&
                ((a.operator = a.right.operator + "="),
        ...
        function r(e, n) {
          ...
          a.right = t;
          for (
            var r, o = a.left.definition().scope;
            (r = s.parent(e++)) !== o;
        ...
        e(tn, function (e, n) {
          ...
          var i =
            e.condition.is_truthy() || e.condition.tail_node().evaluate(n);
          if (!i)
            return (
              n.warn("Condition always false [{file}:{line},{col}]", e.start),
              M(e, [e.condition, e.alternative]).optimize(n)
            );
          if (!(i instanceof se))
            return (
              n.warn("Condition always true [{file}:{line},{col}]", e.start),
              M(e, [e.condition, e.consequent]).optimize(n)
            );
          var r = i.negate(n, $(n));
          I(n, i, r) === r &&
            (e = X(tn, e, {
          ...
          if (
            a instanceof _n &&
            s instanceof _n &&
            a.definition() === s.definition()
          )
            return X(nn, e, { operator: "||", left: a, right: u });
          if (
            s instanceof rn &&
            u instanceof rn &&
            s.operator == u.operator &&
            s.left.equivalent_to(u.left) &&
            (!e.condition.has_side_effects(n) ||
              ("=" == s.operator && !s.left.has_side_effects(n)))
          )
            return X(rn, e, {
              operator: s.operator,
              left: s.left,
          ...
          if (
            ...
            u.TYPE === s.TYPE &&
            0 < s.args.length &&
            s.args.length == u.args.length &&
            s.expression.equivalent_to(u.expression) &&
            !e.condition.has_side_effects(n) &&
            !s.expression.has_side_effects(n) &&
            "number" ==
              typeof (o = (function () {
                for (
                  var e = s.args, n = u.args, t = 0, i = e.length;
                  t < i;
                  t++
                )
          ...
          if (s instanceof tn && s.alternative.equivalent_to(u))
            return X(tn, e, {
              condition: X(nn, e, {
                left: e.condition,
                operator: "&&",
          ...
          if (
            (s instanceof We || u instanceof We) &&
            s.tail_node().equivalent_to(u.tail_node())
          )
            return M(e, [
              X(tn, e, {
                condition: e.condition,
          ...
          if (s instanceof nn && "||" == s.operator && s.right.equivalent_to(u))
            return X(nn, e, {
              operator: "||",
              left: X(nn, e, {
                operator: "&&",
          ...
          function l(e) {
            return e.is_boolean()
              ? e
              : X(Qe, e, { operator: "!", expression: e.negate(n) });
          }
          function p(e) {
            return (
              e instanceof Bn ||
              (f && e instanceof gn && e.getValue()) ||
              (e instanceof Qe &&
                "!" == e.operator &&
                e.expression instanceof gn &&
          ...
          function h(e) {
            return e instanceof We
              ? M(e, e.expressions.slice(0, -1))
              : X(yn, e, { value: 0 });
          }
        }),
        e(Fn, function (e, n) {
          if (!n.option("booleans")) return e;
          if (n.in_boolean_context()) return X(yn, e, { value: +e.value });
          var t = n.parent();
          return t instanceof nn && ("==" == t.operator || "!=" == t.operator)
            ? (n.warn(
              ...
              X(yn, e, { value: +e.value }))
            : X(Qe, e, {
                operator: "!",
                expression: X(yn, e, { value: 1 - e.value }),
              });
        }),
        e(Ze, function (e, n) {
          var t,
          ...
          if (n.option("properties")) {
            ...
            if (o !== r) {
              if ("string" == typeof o)
                if ("undefined" == o) o = void 0;
                else (h = parseFloat(o)).toString() == o && (o = h);
              r = e.property = x(r, q(o, r).transform(n));
              var a = "" + o;
              if (Nn(a) && a.length <= r.print_to_string().length + 1)
                return X(Xe, e, { expression: i, property: a }).optimize(n);
            }
          }
          ...
          if (o !== r) {
            ...
            s &&
              ((i = e.expression = s.expression),
              (r = e.property = s.property));
          }
          if (
            n.option("properties") &&
            n.option("side_effects") &&
            ...
            if (u in c) {
              for (var f = !0, l = [], p = c.length; --p > u; ) {
                (h = c[p].drop_side_effect_free(n)) &&
                  (l.unshift(h), f && h.has_side_effects(n) && (f = !1));
              }
              var d = c[u];
              for (
                d = d instanceof kn ? X(En, d) : d, f || l.unshift(d);
                0 <= --p;
              ...
              return f
                ? (l.push(d), M(e, l).optimize(n))
                : X(Ze, e, {
                    expression: X(on, i, { elements: l }),
                    property: X(yn, r, { value: u }),
                  });
            }
          }
          if (
            ...
            i instanceof _n &&
            "arguments" == i.name &&
            1 == i.definition().orig.length &&
            (t = i.scope) instanceof ke &&
            r instanceof yn
          ) {
            u = r.getValue();
            var v = t.argnames[u];
            if (!v && !n.option("keep_fargs"))
              for (; u >= t.argnames.length; )
                (v = X(pn, t, {
                  name: t.make_var_name("argument_" + t.argnames.length),
                  scope: t,
                })),
                  t.argnames.push(v),
                  t.enclosed.push(t.def_variable(v));
            if (v) {
              var _ = X(_n, e, v);
        ...
        Ge.DEFMETHOD("flatten_object", function (e, n) {
          if (n.option("properties")) {
            ...
            if (t instanceof an)
              for (var i = t.properties, r = i.length; 0 <= --r; ) {
                var o = i[r];
                if ("" + o.key == e) {
                  if (
                    !oe(i, function (e) {
        ...
        e(Xe, function (e, n) {
          ("arguments" != e.property && "caller" != e.property) ||
            n.warn(
              "Function.protoype.{prop} not supported [{file}:{line},{col}]",
              {
                prop: e.property,
                file: e.start.file,
                line: e.start.line,
          ...
          if (
            ...
            if (H(i))
              switch (i.name) {
                case "Array":
                  e.expression = X(on, e.expression, { elements: [] });
                  break;
                case "Function":
                  ...
                  break;
                case "Number":
                  e.expression = X(yn, e.expression, { value: 0 });
                  break;
                case "Object":
                  e.expression = X(an, e.expression, { properties: [] });
                  break;
                case "RegExp":
                  e.expression = X(wn, e.expression, { value: /t/ });
                  break;
                case "String":
                  e.expression = X(bn, e.expression, { value: "" });
              }
          }
    ...
    (function () {
      var n = function (e) {
          for (var n = !0, t = 0; t < e.length; t++)
            n && e[t] instanceof ue && e[t].body instanceof bn
              ? (e[t] = new fe({
                  start: e[t].start,
                  end: e[t].end,
              ...
              : !n ||
                (e[t] instanceof ue && e[t].body instanceof bn) ||
                (n = !1);
          return e;
        },
        i = {
          Program: function (e) {
            return new Ee({ start: s(e), end: u(e), body: n(e.body.map(c)) });
          },
          ...
          ExpressionStatement: function (e) {
            return new le({ start: s(e), end: u(e), body: c(e.expression) });
          },
          TryStatement: function (e) {
            var n = e.handlers || [e.handler];
            if (1 < n.length || (e.guardedHandlers && e.guardedHandlers.length))
          ...
          Property: function (e) {
            ...
            return "init" == e.kind
              ? new un(t)
              : ((t.key = new K({ name: t.key })),
                (t.value = new De(t.value)),
                "get" == e.kind
                  ? new Z(t)
                  : "set" == e.kind
                  ? new X(t)
          ...
          Literal: function (e) {
            ...
            switch (typeof n) {
              ...
              default:
                ...
                return (
                  i && i.pattern
                    ? (t.value = new RegExp(i.pattern, i.flags).toString())
      ...
      function e(e, n, t) {
        ...
        (a += "return {\ntype: " + JSON.stringify(e)),
          t &&
            t.split(/\s*,\s*/).forEach(function (e) {
      ...
      (i.UpdateExpression = i.UnaryExpression =
        function (e) {
          return new (
            ("prefix" in e ? e.prefix : "UnaryExpression" == e.type) ? Qe : en
          )({
            start: s(e),
            end: u(e),
            operator: e.operator,
        ...
        e("EmptyStatement", he),
        e("BlockStatement", de, "body@body"),
        e(
          "IfStatement",
          Me,
          "test>condition, consequent>body, alternate>alternative"
        ),
        e("LabeledStatement", ve, "label>label, body>body"),
        e("BreakStatement", $e, "label>label"),
        e("ContinueStatement", ze, "label>label"),
        e("WithStatement", xe, "object>expression, body>body"),
        e("SwitchStatement", qe, "discriminant>expression, cases@body"),
        e("ReturnStatement", Te, "argument>value"),
        e("ThrowStatement", G, "argument>value"),
        e("WhileStatement", be, "test>condition, body>body"),
        e("DoWhileStatement", ge, "test>condition, body>body"),
        e(
          "ForStatement",
          ye,
          "init>init, test>condition, update>step, body>body"
        ),
        e("ForInStatement", we, "left>init, right>object, body>body"),
        e("DebuggerStatement", ce),
        e("VariableDeclarator", Ve, "id>name, init>value"),
        e("CatchClause", Ie, "param>argname, body%body"),
        e("ThisExpression", mn),
        e("BinaryExpression", nn, "operator=operator, left>left, right>right"),
        e("LogicalExpression", nn, "operator=operator, left>left, right>right"),
        e(
        ...
        e("NewExpression", Je, "callee>expression, arguments@args"),
        e("CallExpression", Ye, "callee>expression, arguments@args"),
        f(Ee, function (e) {
          return d("Program", e);
        }),
        f(Ce, function (e) {
        ...
        f(le, function (e) {
          return { type: "ExpressionStatement", expression: l(e.body) };
        }),
        f(je, function (e) {
          return {
            type: "SwitchCase",
        ...
        f(on, function (e) {
          return { type: "ArrayExpression", elements: e.elements.map(l) };
        }),
        f(an, function (e) {
          return { type: "ObjectExpression", properties: e.properties.map(l) };
        }),
        f(sn, function (e) {
          var n,
            t = {
          ...
          return (
            e instanceof un
              ...
              : e instanceof Z
              ? (n = "get")
              : e instanceof X && (n = "set"),
            { type: "Property", kind: n, key: t, value: l(e.value) }
          );
        }),
        f(cn, function (e) {
          var n = e.definition();
        ...
        f(gn, function (e) {
          ...
          return "number" == typeof n && (n < 0 || (0 === n && 1 / n < 0))
            ...
            : { type: "Literal", value: n, raw: e.start.raw };
        }),
        f(a, function (e) {
          return { type: "Identifier", name: String(e.value) };
        }),
        Fn.DEFMETHOD("to_mozilla_ast", gn.prototype.to_mozilla_ast),
        xn.DEFMETHOD("to_mozilla_ast", gn.prototype.to_mozilla_ast),
        kn.DEFMETHOD("to_mozilla_ast", function () {
          return null;
        }),
        pe.DEFMETHOD("to_mozilla_ast", de.prototype.to_mozilla_ast),
        ke.DEFMETHOD("to_mozilla_ast", Fe.prototype.to_mozilla_ast);
      var o = null;
      function c(e) {
        o.push(e);
      ...
      function f(e, r) {
        e.DEFMETHOD("to_mozilla_ast", function () {
          return (
            ...
            (t = e.start),
            (i = e.end),
            null != t.pos && null != i.endpos && (n.range = [t.pos, i.endpos]),
            t.line &&
              ((n.loc = {
                start: { line: t.line, column: t.col },
                end: i.endline ? { line: i.endline, column: i.endcol } : null,
              }),
              t.file && (n.loc.source = t.file)),
            n
          );
          var e, n, t, i;
        });
      ...
      function p(e) {
        return { type: "BlockStatement", body: e.body.map(l) };
      }
      function d(e, n) {
        var t = n.body.map(l);
        return (
          n.body[0] instanceof le &&
            n.body[0].body instanceof bn &&
            t.unshift(l(new he(n.body[0]))),
          { type: e, body: t }
        );
      }
  ...
  function A(e) {
    e &&
      ("props" in e
        ? e.props instanceof O || (e.props = O.fromObject(e.props))
        : (e.props = new O()));
  }
  function E(e) {
  ...
  (h.Dictionary = O),
    (h.TreeWalker = Sn),
    (h.TreeTransformer = Xn),
    (h.minify = function (e, n) {
      var t,
        i,
        r = se.warn_function;
      try {
        ...
        void 0 === n.rename && (n.rename = n.compress && n.mangle),
          x("ie8", n, ["compress", "mangle", "output"]),
          x("keep_fnames", n, ["compress", "mangle"]),
          x("toplevel", n, ["compress", "mangle"]),
          x("warnings", n, ["compress"]),
          n.mangle &&
            ((n.mangle = Y(
              n.mangle,
              {
            ...
            n.mangle.properties &&
              ("object" != typeof n.mangle.properties &&
                (n.mangle.properties = {}),
              n.mangle.properties.keep_quoted &&
                ((o = n.mangle.properties.reserved),
                Array.isArray(o) || (o = []),
                (n.mangle.properties.reserved = o)),
              !n.nameCache ||
                "cache" in n.mangle.properties ||
                (n.mangle.properties.cache = n.nameCache.props || {})),
            A(n.mangle.cache),
            A(n.mangle.properties.cache)),
          n.sourceMap &&
            (n.sourceMap = Y(
              n.sourceMap,
              {
        ...
        if (
          ...
          for (var c in ("string" == typeof e && (e = [e]),
          (n.parse = n.parse || {}),
          ...
          e))
            if (
              ae(e, c) &&
              ((n.parse.filename = c),
              (n.parse.toplevel = Gn(e[c], n.parse)),
              n.sourceMap && "inline" == n.sourceMap.content)
            ) {
              ...
              n.sourceMap.content =
                ...
                (i =
                  ...
                  ? y(i[2])
                  : (se.warn("inline source map not found"), null));
            }
          s = n.parse.toplevel;
        }
        o &&
          (function (e, n) {
            ...
            e.walk(
              new Sn(function (e) {
                e instanceof un && e.quote
                  ? t(e.key)
                  : e instanceof Ze && b(e.property, t);
              })
            );
          })(s, o),
          n.wrap && (s = s.wrap_commonjs(n.wrap)),
          a && (a.rename = Date.now()),
          n.rename && (s.figure_out_scope(n.mangle), s.expand_names(n.mangle)),
          a && (a.compress = Date.now()),
          n.compress && (s = new et(n.compress).compress(s)),
          a && (a.scope = Date.now()),
          n.mangle && s.figure_out_scope(n.mangle),
          a && (a.mangle = Date.now()),
          n.mangle &&
            (s.compute_char_frequency(n.mangle), s.mangle_names(n.mangle)),
          a && (a.properties = Date.now()),
          n.mangle && n.mangle.properties && (s = d(s, n.mangle.properties)),
          a && (a.output = Date.now());
        var f = {};
        if (
          (n.output.ast && (f.ast = s), !ae(n.output, "code") || n.output.code)
        ) {
          if (
            n.sourceMap &&
            ("string" == typeof n.sourceMap.content &&
              (n.sourceMap.content = JSON.parse(n.sourceMap.content)),
            (n.output.source_map = (function (s) {
              s = Y(s, {
                file: null,
                root: null,
                orig: null,
              ...
              return (
                c &&
                  Array.isArray(s.orig.sources) &&
                  c._sources.toArray().forEach(function (e) {
                    var n = c.sourceContentFor(e, !0);
                    n && u.setSourceContent(e, n);
                  }),
                {
                  add: function (e, n, t, i, r, o) {
                    if (c) {
                      var a = c.originalPositionFor({ line: i, column: r });
                    ...
                    u.addMapping({
                      generated: { line: n + s.dest_line_diff, column: t },
                      original: { line: i + s.orig_line_diff, column: r },
                      source: e,
                      name: o,
                    });
                  },
        ...
        return (
          n.nameCache &&
            n.mangle &&
            (n.mangle.cache && (n.nameCache.vars = E(n.mangle.cache)),
            n.mangle.properties &&
              n.mangle.properties.cache &&
              (n.nameCache.props = E(n.mangle.properties.cache))),
          a &&
            ((a.end = Date.now()),
            (f.timings = {
              parse: 0.001 * (a.rename - a.parse),
              rename: 0.001 * (a.compress - a.rename),
              compress: 0.001 * (a.scope - a.compress),
              scope: 0.001 * (a.mangle - a.scope),
              mangle: 0.001 * (a.properties - a.mangle),
              properties: 0.001 * (a.output - a.properties),
              output: 0.001 * (a.end - a.output),
              total: 0.001 * (a.end - a.start),
            })),
          u.length && (f.warnings = u),
          f
        );
      } catch (e) {
        return { error: e };
